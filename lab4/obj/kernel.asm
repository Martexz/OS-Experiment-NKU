...
ffffffffc0200060:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc0200062:	62b030ef          	jal	ra,ffffffffc0203e8c <memset>
    dtb_init();
...
ffffffffc0200072:	e7258593          	addi	a1,a1,-398 # ffffffffc0203ee0 <etext+0x6>
ffffffffc0200076:	00004517          	auipc	a0,0x4
ffffffffc020007a:	e8a50513          	addi	a0,a0,-374 # ffffffffc0203f00 <etext+0x26>
...
ffffffffc0200096:	5b6030ef          	jal	ra,ffffffffc020364c <proc_init>
...
ffffffffc02000a2:	7f8030ef          	jal	ra,ffffffffc020389a <cpu_idle>
...
ffffffffc02000c0:	e4c50513          	addi	a0,a0,-436 # ffffffffc0203f08 <etext+0x2e>
...
ffffffffc0200186:	c602                	sw	zero,12(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc0200188:	0e1030ef          	jal	ra,ffffffffc0203a68 <vprintfmt>
    return cnt;
}
...
ffffffffc02001bc:	c202                	sw	zero,4(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc02001be:	0ab030ef          	jal	ra,ffffffffc0203a68 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001e2:	d3250513          	addi	a0,a0,-718 # ffffffffc0203f10 <etext+0x36>
{
...
ffffffffc02001f8:	d3c50513          	addi	a0,a0,-708 # ffffffffc0203f30 <etext+0x56>
ffffffffc02001fc:	f99ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200200:	00004597          	auipc	a1,0x4
ffffffffc0200204:	cda58593          	addi	a1,a1,-806 # ffffffffc0203eda <etext>
ffffffffc0200208:	00004517          	auipc	a0,0x4
ffffffffc020020c:	d4850513          	addi	a0,a0,-696 # ffffffffc0203f50 <etext+0x76>
...
ffffffffc0200220:	d5450513          	addi	a0,a0,-684 # ffffffffc0203f70 <etext+0x96>
...
ffffffffc0200234:	d6050513          	addi	a0,a0,-672 # ffffffffc0203f90 <etext+0xb6>
...
ffffffffc0200262:	d5250513          	addi	a0,a0,-686 # ffffffffc0203fb0 <etext+0xd6>
}
...
ffffffffc0200270:	d7460613          	addi	a2,a2,-652 # ffffffffc0203fe0 <etext+0x106>
ffffffffc0200274:	04900593          	li	a1,73
ffffffffc0200278:	00004517          	auipc	a0,0x4
ffffffffc020027c:	d8050513          	addi	a0,a0,-640 # ffffffffc0203ff8 <etext+0x11e>
{
...
ffffffffc020028c:	d8860613          	addi	a2,a2,-632 # ffffffffc0204010 <etext+0x136>
ffffffffc0200290:	00004597          	auipc	a1,0x4
ffffffffc0200294:	da058593          	addi	a1,a1,-608 # ffffffffc0204030 <etext+0x156>
ffffffffc0200298:	00004517          	auipc	a0,0x4
ffffffffc020029c:	da050513          	addi	a0,a0,-608 # ffffffffc0204038 <etext+0x15e>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002aa:	da260613          	addi	a2,a2,-606 # ffffffffc0204048 <etext+0x16e>
ffffffffc02002ae:	00004597          	auipc	a1,0x4
ffffffffc02002b2:	dc258593          	addi	a1,a1,-574 # ffffffffc0204070 <etext+0x196>
ffffffffc02002b6:	00004517          	auipc	a0,0x4
ffffffffc02002ba:	d8250513          	addi	a0,a0,-638 # ffffffffc0204038 <etext+0x15e>
ffffffffc02002be:	ed7ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
ffffffffc02002c2:	00004617          	auipc	a2,0x4
ffffffffc02002c6:	dbe60613          	addi	a2,a2,-578 # ffffffffc0204080 <etext+0x1a6>
ffffffffc02002ca:	00004597          	auipc	a1,0x4
ffffffffc02002ce:	dd658593          	addi	a1,a1,-554 # ffffffffc02040a0 <etext+0x1c6>
ffffffffc02002d2:	00004517          	auipc	a0,0x4
ffffffffc02002d6:	d6650513          	addi	a0,a0,-666 # ffffffffc0204038 <etext+0x15e>
...
ffffffffc0200310:	da450513          	addi	a0,a0,-604 # ffffffffc02040b0 <etext+0x1d6>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200332:	daa50513          	addi	a0,a0,-598 # ffffffffc02040d8 <etext+0x1fe>
...
ffffffffc020035c:	da890913          	addi	s2,s2,-600 # ffffffffc0204100 <etext+0x226>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200360:	00004497          	auipc	s1,0x4
ffffffffc0200364:	da848493          	addi	s1,s1,-600 # ffffffffc0204108 <etext+0x22e>
        if (argc == MAXARGS - 1) {
ffffffffc0200368:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020036a:	00004b17          	auipc	s6,0x4
ffffffffc020036e:	da6b0b13          	addi	s6,s6,-602 # ffffffffc0204110 <etext+0x236>
        argv[argc ++] = buf;
ffffffffc0200372:	00004a17          	auipc	s4,0x4
ffffffffc0200376:	cbea0a13          	addi	s4,s4,-834 # ffffffffc0204030 <etext+0x156>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	291030ef          	jal	ra,ffffffffc0203e32 <strcmp>
...
ffffffffc02003b4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003b6:	27d030ef          	jal	ra,ffffffffc0203e32 <strcmp>
...
ffffffffc02003f4:	283030ef          	jal	ra,ffffffffc0203e76 <strchr>
...
ffffffffc0200432:	245030ef          	jal	ra,ffffffffc0203e76 <strchr>
...
ffffffffc0200450:	ce450513          	addi	a0,a0,-796 # ffffffffc0204130 <etext+0x256>
...
ffffffffc0200746:	6a4030ef          	jal	ra,ffffffffc0203dea <strlen>
...
ffffffffc0200752:	2a01                	sext.w	s4,s4
                if (strncmp(name, "memory", 6) == 0) {
ffffffffc0200754:	6fc030ef          	jal	ra,ffffffffc0203e50 <strncmp>
...
ffffffffc02007ea:	648030ef          	jal	ra,ffffffffc0203e32 <strcmp>
...
ffffffffc0200c26:	8406b723          	sd	zero,-1970(a3) # ffffffffc020d470 <ticks>
            if (num == 10)
ffffffffc0200c2a:	46a9                	li	a3,10
            num ++;
ffffffffc0200c2c:	0017861b          	addiw	a2,a5,1
ffffffffc0200c30:	c310                	sw	a2,0(a4)
            if (num == 10)
ffffffffc0200c32:	fcd611e3          	bne	a2,a3,ffffffffc0200bf4 <interrupt_handler+0x72>
	SBI_CALL_0(SBI_SHUTDOWN);
...
ffffffffc0200c52:	cc270713          	addi	a4,a4,-830 # ffffffffc0204910 <commands+0x7c8>
...
ffffffffc0200e9a:	b9263603          	ld	a2,-1134(a2) # ffffffffc0205a28 <nbase>
...
ffffffffc02010e0:	87468693          	addi	a3,a3,-1932 # ffffffffc0204950 <commands+0x808>
ffffffffc02010e4:	00004617          	auipc	a2,0x4
ffffffffc02010e8:	87c60613          	addi	a2,a2,-1924 # ffffffffc0204960 <commands+0x818>
ffffffffc02010ec:	0f000593          	li	a1,240
ffffffffc02010f0:	00004517          	auipc	a0,0x4
ffffffffc02010f4:	88850513          	addi	a0,a0,-1912 # ffffffffc0204978 <commands+0x830>
ffffffffc02010f8:	b62ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc02010fc:	00004697          	auipc	a3,0x4
ffffffffc0201100:	91468693          	addi	a3,a3,-1772 # ffffffffc0204a10 <commands+0x8c8>
ffffffffc0201104:	00004617          	auipc	a2,0x4
ffffffffc0201108:	85c60613          	addi	a2,a2,-1956 # ffffffffc0204960 <commands+0x818>
ffffffffc020110c:	0bd00593          	li	a1,189
ffffffffc0201110:	00004517          	auipc	a0,0x4
ffffffffc0201114:	86850513          	addi	a0,a0,-1944 # ffffffffc0204978 <commands+0x830>
ffffffffc0201118:	b42ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc020111c:	00004697          	auipc	a3,0x4
ffffffffc0201120:	91c68693          	addi	a3,a3,-1764 # ffffffffc0204a38 <commands+0x8f0>
ffffffffc0201124:	00004617          	auipc	a2,0x4
ffffffffc0201128:	83c60613          	addi	a2,a2,-1988 # ffffffffc0204960 <commands+0x818>
ffffffffc020112c:	0be00593          	li	a1,190
ffffffffc0201130:	00004517          	auipc	a0,0x4
ffffffffc0201134:	84850513          	addi	a0,a0,-1976 # ffffffffc0204978 <commands+0x830>
ffffffffc0201138:	b22ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc020113c:	00004697          	auipc	a3,0x4
ffffffffc0201140:	93c68693          	addi	a3,a3,-1732 # ffffffffc0204a78 <commands+0x930>
ffffffffc0201144:	00004617          	auipc	a2,0x4
ffffffffc0201148:	81c60613          	addi	a2,a2,-2020 # ffffffffc0204960 <commands+0x818>
ffffffffc020114c:	0c000593          	li	a1,192
ffffffffc0201150:	00004517          	auipc	a0,0x4
ffffffffc0201154:	82850513          	addi	a0,a0,-2008 # ffffffffc0204978 <commands+0x830>
ffffffffc0201158:	b02ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(!list_empty(&free_list));
ffffffffc020115c:	00004697          	auipc	a3,0x4
ffffffffc0201160:	9a468693          	addi	a3,a3,-1628 # ffffffffc0204b00 <commands+0x9b8>
ffffffffc0201164:	00003617          	auipc	a2,0x3
ffffffffc0201168:	7fc60613          	addi	a2,a2,2044 # ffffffffc0204960 <commands+0x818>
ffffffffc020116c:	0d900593          	li	a1,217
ffffffffc0201170:	00004517          	auipc	a0,0x4
ffffffffc0201174:	80850513          	addi	a0,a0,-2040 # ffffffffc0204978 <commands+0x830>
ffffffffc0201178:	ae2ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc020117c:	00004697          	auipc	a3,0x4
ffffffffc0201180:	83468693          	addi	a3,a3,-1996 # ffffffffc02049b0 <commands+0x868>
ffffffffc0201184:	00003617          	auipc	a2,0x3
ffffffffc0201188:	7dc60613          	addi	a2,a2,2012 # ffffffffc0204960 <commands+0x818>
ffffffffc020118c:	0d200593          	li	a1,210
ffffffffc0201190:	00003517          	auipc	a0,0x3
ffffffffc0201194:	7e850513          	addi	a0,a0,2024 # ffffffffc0204978 <commands+0x830>
ffffffffc0201198:	ac2ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free == 3);
ffffffffc020119c:	00004697          	auipc	a3,0x4
ffffffffc02011a0:	95468693          	addi	a3,a3,-1708 # ffffffffc0204af0 <commands+0x9a8>
ffffffffc02011a4:	00003617          	auipc	a2,0x3
ffffffffc02011a8:	7bc60613          	addi	a2,a2,1980 # ffffffffc0204960 <commands+0x818>
ffffffffc02011ac:	0d000593          	li	a1,208
ffffffffc02011b0:	00003517          	auipc	a0,0x3
ffffffffc02011b4:	7c850513          	addi	a0,a0,1992 # ffffffffc0204978 <commands+0x830>
ffffffffc02011b8:	aa2ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011bc:	00004697          	auipc	a3,0x4
ffffffffc02011c0:	91c68693          	addi	a3,a3,-1764 # ffffffffc0204ad8 <commands+0x990>
ffffffffc02011c4:	00003617          	auipc	a2,0x3
ffffffffc02011c8:	79c60613          	addi	a2,a2,1948 # ffffffffc0204960 <commands+0x818>
ffffffffc02011cc:	0cb00593          	li	a1,203
ffffffffc02011d0:	00003517          	auipc	a0,0x3
ffffffffc02011d4:	7a850513          	addi	a0,a0,1960 # ffffffffc0204978 <commands+0x830>
ffffffffc02011d8:	a82ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc02011dc:	00004697          	auipc	a3,0x4
ffffffffc02011e0:	8dc68693          	addi	a3,a3,-1828 # ffffffffc0204ab8 <commands+0x970>
ffffffffc02011e4:	00003617          	auipc	a2,0x3
ffffffffc02011e8:	77c60613          	addi	a2,a2,1916 # ffffffffc0204960 <commands+0x818>
ffffffffc02011ec:	0c200593          	li	a1,194
ffffffffc02011f0:	00003517          	auipc	a0,0x3
ffffffffc02011f4:	78850513          	addi	a0,a0,1928 # ffffffffc0204978 <commands+0x830>
ffffffffc02011f8:	a62ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(p0 != NULL);
ffffffffc02011fc:	00004697          	auipc	a3,0x4
ffffffffc0201200:	94c68693          	addi	a3,a3,-1716 # ffffffffc0204b48 <commands+0xa00>
ffffffffc0201204:	00003617          	auipc	a2,0x3
ffffffffc0201208:	75c60613          	addi	a2,a2,1884 # ffffffffc0204960 <commands+0x818>
ffffffffc020120c:	0f800593          	li	a1,248
ffffffffc0201210:	00003517          	auipc	a0,0x3
ffffffffc0201214:	76850513          	addi	a0,a0,1896 # ffffffffc0204978 <commands+0x830>
ffffffffc0201218:	a42ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free == 0);
ffffffffc020121c:	00004697          	auipc	a3,0x4
ffffffffc0201220:	91c68693          	addi	a3,a3,-1764 # ffffffffc0204b38 <commands+0x9f0>
ffffffffc0201224:	00003617          	auipc	a2,0x3
ffffffffc0201228:	73c60613          	addi	a2,a2,1852 # ffffffffc0204960 <commands+0x818>
ffffffffc020122c:	0df00593          	li	a1,223
ffffffffc0201230:	00003517          	auipc	a0,0x3
ffffffffc0201234:	74850513          	addi	a0,a0,1864 # ffffffffc0204978 <commands+0x830>
ffffffffc0201238:	a22ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc020123c:	00004697          	auipc	a3,0x4
ffffffffc0201240:	89c68693          	addi	a3,a3,-1892 # ffffffffc0204ad8 <commands+0x990>
ffffffffc0201244:	00003617          	auipc	a2,0x3
ffffffffc0201248:	71c60613          	addi	a2,a2,1820 # ffffffffc0204960 <commands+0x818>
ffffffffc020124c:	0dd00593          	li	a1,221
ffffffffc0201250:	00003517          	auipc	a0,0x3
ffffffffc0201254:	72850513          	addi	a0,a0,1832 # ffffffffc0204978 <commands+0x830>
ffffffffc0201258:	a02ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc020125c:	00004697          	auipc	a3,0x4
ffffffffc0201260:	8bc68693          	addi	a3,a3,-1860 # ffffffffc0204b18 <commands+0x9d0>
ffffffffc0201264:	00003617          	auipc	a2,0x3
ffffffffc0201268:	6fc60613          	addi	a2,a2,1788 # ffffffffc0204960 <commands+0x818>
ffffffffc020126c:	0dc00593          	li	a1,220
ffffffffc0201270:	00003517          	auipc	a0,0x3
ffffffffc0201274:	70850513          	addi	a0,a0,1800 # ffffffffc0204978 <commands+0x830>
ffffffffc0201278:	9e2ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc020127c:	00003697          	auipc	a3,0x3
ffffffffc0201280:	73468693          	addi	a3,a3,1844 # ffffffffc02049b0 <commands+0x868>
ffffffffc0201284:	00003617          	auipc	a2,0x3
ffffffffc0201288:	6dc60613          	addi	a2,a2,1756 # ffffffffc0204960 <commands+0x818>
ffffffffc020128c:	0b900593          	li	a1,185
ffffffffc0201290:	00003517          	auipc	a0,0x3
ffffffffc0201294:	6e850513          	addi	a0,a0,1768 # ffffffffc0204978 <commands+0x830>
ffffffffc0201298:	9c2ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc020129c:	00004697          	auipc	a3,0x4
ffffffffc02012a0:	83c68693          	addi	a3,a3,-1988 # ffffffffc0204ad8 <commands+0x990>
ffffffffc02012a4:	00003617          	auipc	a2,0x3
ffffffffc02012a8:	6bc60613          	addi	a2,a2,1724 # ffffffffc0204960 <commands+0x818>
ffffffffc02012ac:	0d600593          	li	a1,214
ffffffffc02012b0:	00003517          	auipc	a0,0x3
ffffffffc02012b4:	6c850513          	addi	a0,a0,1736 # ffffffffc0204978 <commands+0x830>
ffffffffc02012b8:	9a2ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02012bc:	00003697          	auipc	a3,0x3
ffffffffc02012c0:	73468693          	addi	a3,a3,1844 # ffffffffc02049f0 <commands+0x8a8>
ffffffffc02012c4:	00003617          	auipc	a2,0x3
ffffffffc02012c8:	69c60613          	addi	a2,a2,1692 # ffffffffc0204960 <commands+0x818>
ffffffffc02012cc:	0d400593          	li	a1,212
ffffffffc02012d0:	00003517          	auipc	a0,0x3
ffffffffc02012d4:	6a850513          	addi	a0,a0,1704 # ffffffffc0204978 <commands+0x830>
ffffffffc02012d8:	982ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012dc:	00003697          	auipc	a3,0x3
ffffffffc02012e0:	6f468693          	addi	a3,a3,1780 # ffffffffc02049d0 <commands+0x888>
ffffffffc02012e4:	00003617          	auipc	a2,0x3
ffffffffc02012e8:	67c60613          	addi	a2,a2,1660 # ffffffffc0204960 <commands+0x818>
ffffffffc02012ec:	0d300593          	li	a1,211
ffffffffc02012f0:	00003517          	auipc	a0,0x3
ffffffffc02012f4:	68850513          	addi	a0,a0,1672 # ffffffffc0204978 <commands+0x830>
ffffffffc02012f8:	962ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02012fc:	00003697          	auipc	a3,0x3
ffffffffc0201300:	6f468693          	addi	a3,a3,1780 # ffffffffc02049f0 <commands+0x8a8>
ffffffffc0201304:	00003617          	auipc	a2,0x3
ffffffffc0201308:	65c60613          	addi	a2,a2,1628 # ffffffffc0204960 <commands+0x818>
ffffffffc020130c:	0bb00593          	li	a1,187
ffffffffc0201310:	00003517          	auipc	a0,0x3
ffffffffc0201314:	66850513          	addi	a0,a0,1640 # ffffffffc0204978 <commands+0x830>
ffffffffc0201318:	942ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(count == 0);
ffffffffc020131c:	00004697          	auipc	a3,0x4
ffffffffc0201320:	97c68693          	addi	a3,a3,-1668 # ffffffffc0204c98 <commands+0xb50>
ffffffffc0201324:	00003617          	auipc	a2,0x3
ffffffffc0201328:	63c60613          	addi	a2,a2,1596 # ffffffffc0204960 <commands+0x818>
ffffffffc020132c:	12500593          	li	a1,293
ffffffffc0201330:	00003517          	auipc	a0,0x3
ffffffffc0201334:	64850513          	addi	a0,a0,1608 # ffffffffc0204978 <commands+0x830>
ffffffffc0201338:	922ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free == 0);
ffffffffc020133c:	00003697          	auipc	a3,0x3
ffffffffc0201340:	7fc68693          	addi	a3,a3,2044 # ffffffffc0204b38 <commands+0x9f0>
ffffffffc0201344:	00003617          	auipc	a2,0x3
ffffffffc0201348:	61c60613          	addi	a2,a2,1564 # ffffffffc0204960 <commands+0x818>
ffffffffc020134c:	11a00593          	li	a1,282
ffffffffc0201350:	00003517          	auipc	a0,0x3
ffffffffc0201354:	62850513          	addi	a0,a0,1576 # ffffffffc0204978 <commands+0x830>
ffffffffc0201358:	902ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc020135c:	00003697          	auipc	a3,0x3
ffffffffc0201360:	77c68693          	addi	a3,a3,1916 # ffffffffc0204ad8 <commands+0x990>
ffffffffc0201364:	00003617          	auipc	a2,0x3
ffffffffc0201368:	5fc60613          	addi	a2,a2,1532 # ffffffffc0204960 <commands+0x818>
ffffffffc020136c:	11800593          	li	a1,280
ffffffffc0201370:	00003517          	auipc	a0,0x3
ffffffffc0201374:	60850513          	addi	a0,a0,1544 # ffffffffc0204978 <commands+0x830>
ffffffffc0201378:	8e2ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc020137c:	00003697          	auipc	a3,0x3
ffffffffc0201380:	71c68693          	addi	a3,a3,1820 # ffffffffc0204a98 <commands+0x950>
ffffffffc0201384:	00003617          	auipc	a2,0x3
ffffffffc0201388:	5dc60613          	addi	a2,a2,1500 # ffffffffc0204960 <commands+0x818>
ffffffffc020138c:	0c100593          	li	a1,193
ffffffffc0201390:	00003517          	auipc	a0,0x3
ffffffffc0201394:	5e850513          	addi	a0,a0,1512 # ffffffffc0204978 <commands+0x830>
ffffffffc0201398:	8c2ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc020139c:	00004697          	auipc	a3,0x4
ffffffffc02013a0:	8bc68693          	addi	a3,a3,-1860 # ffffffffc0204c58 <commands+0xb10>
ffffffffc02013a4:	00003617          	auipc	a2,0x3
ffffffffc02013a8:	5bc60613          	addi	a2,a2,1468 # ffffffffc0204960 <commands+0x818>
ffffffffc02013ac:	11200593          	li	a1,274
ffffffffc02013b0:	00003517          	auipc	a0,0x3
ffffffffc02013b4:	5c850513          	addi	a0,a0,1480 # ffffffffc0204978 <commands+0x830>
ffffffffc02013b8:	8a2ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02013bc:	00004697          	auipc	a3,0x4
ffffffffc02013c0:	87c68693          	addi	a3,a3,-1924 # ffffffffc0204c38 <commands+0xaf0>
ffffffffc02013c4:	00003617          	auipc	a2,0x3
ffffffffc02013c8:	59c60613          	addi	a2,a2,1436 # ffffffffc0204960 <commands+0x818>
ffffffffc02013cc:	11000593          	li	a1,272
ffffffffc02013d0:	00003517          	auipc	a0,0x3
ffffffffc02013d4:	5a850513          	addi	a0,a0,1448 # ffffffffc0204978 <commands+0x830>
ffffffffc02013d8:	882ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02013dc:	00004697          	auipc	a3,0x4
ffffffffc02013e0:	83468693          	addi	a3,a3,-1996 # ffffffffc0204c10 <commands+0xac8>
ffffffffc02013e4:	00003617          	auipc	a2,0x3
ffffffffc02013e8:	57c60613          	addi	a2,a2,1404 # ffffffffc0204960 <commands+0x818>
ffffffffc02013ec:	10e00593          	li	a1,270
ffffffffc02013f0:	00003517          	auipc	a0,0x3
ffffffffc02013f4:	58850513          	addi	a0,a0,1416 # ffffffffc0204978 <commands+0x830>
ffffffffc02013f8:	862ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02013fc:	00003697          	auipc	a3,0x3
ffffffffc0201400:	7ec68693          	addi	a3,a3,2028 # ffffffffc0204be8 <commands+0xaa0>
ffffffffc0201404:	00003617          	auipc	a2,0x3
ffffffffc0201408:	55c60613          	addi	a2,a2,1372 # ffffffffc0204960 <commands+0x818>
ffffffffc020140c:	10d00593          	li	a1,269
ffffffffc0201410:	00003517          	auipc	a0,0x3
ffffffffc0201414:	56850513          	addi	a0,a0,1384 # ffffffffc0204978 <commands+0x830>
ffffffffc0201418:	842ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(p0 + 2 == p1);
ffffffffc020141c:	00003697          	auipc	a3,0x3
ffffffffc0201420:	7bc68693          	addi	a3,a3,1980 # ffffffffc0204bd8 <commands+0xa90>
ffffffffc0201424:	00003617          	auipc	a2,0x3
ffffffffc0201428:	53c60613          	addi	a2,a2,1340 # ffffffffc0204960 <commands+0x818>
ffffffffc020142c:	10800593          	li	a1,264
ffffffffc0201430:	00003517          	auipc	a0,0x3
ffffffffc0201434:	54850513          	addi	a0,a0,1352 # ffffffffc0204978 <commands+0x830>
ffffffffc0201438:	822ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc020143c:	00003697          	auipc	a3,0x3
ffffffffc0201440:	69c68693          	addi	a3,a3,1692 # ffffffffc0204ad8 <commands+0x990>
ffffffffc0201444:	00003617          	auipc	a2,0x3
ffffffffc0201448:	51c60613          	addi	a2,a2,1308 # ffffffffc0204960 <commands+0x818>
ffffffffc020144c:	10700593          	li	a1,263
ffffffffc0201450:	00003517          	auipc	a0,0x3
ffffffffc0201454:	52850513          	addi	a0,a0,1320 # ffffffffc0204978 <commands+0x830>
ffffffffc0201458:	802ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc020145c:	00003697          	auipc	a3,0x3
ffffffffc0201460:	75c68693          	addi	a3,a3,1884 # ffffffffc0204bb8 <commands+0xa70>
ffffffffc0201464:	00003617          	auipc	a2,0x3
ffffffffc0201468:	4fc60613          	addi	a2,a2,1276 # ffffffffc0204960 <commands+0x818>
ffffffffc020146c:	10600593          	li	a1,262
ffffffffc0201470:	00003517          	auipc	a0,0x3
ffffffffc0201474:	50850513          	addi	a0,a0,1288 # ffffffffc0204978 <commands+0x830>
ffffffffc0201478:	fe3fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc020147c:	00003697          	auipc	a3,0x3
ffffffffc0201480:	70c68693          	addi	a3,a3,1804 # ffffffffc0204b88 <commands+0xa40>
ffffffffc0201484:	00003617          	auipc	a2,0x3
ffffffffc0201488:	4dc60613          	addi	a2,a2,1244 # ffffffffc0204960 <commands+0x818>
ffffffffc020148c:	10500593          	li	a1,261
ffffffffc0201490:	00003517          	auipc	a0,0x3
ffffffffc0201494:	4e850513          	addi	a0,a0,1256 # ffffffffc0204978 <commands+0x830>
ffffffffc0201498:	fc3fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc020149c:	00003697          	auipc	a3,0x3
ffffffffc02014a0:	6d468693          	addi	a3,a3,1748 # ffffffffc0204b70 <commands+0xa28>
ffffffffc02014a4:	00003617          	auipc	a2,0x3
ffffffffc02014a8:	4bc60613          	addi	a2,a2,1212 # ffffffffc0204960 <commands+0x818>
ffffffffc02014ac:	10400593          	li	a1,260
ffffffffc02014b0:	00003517          	auipc	a0,0x3
ffffffffc02014b4:	4c850513          	addi	a0,a0,1224 # ffffffffc0204978 <commands+0x830>
ffffffffc02014b8:	fa3fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02014bc:	00003697          	auipc	a3,0x3
ffffffffc02014c0:	61c68693          	addi	a3,a3,1564 # ffffffffc0204ad8 <commands+0x990>
ffffffffc02014c4:	00003617          	auipc	a2,0x3
ffffffffc02014c8:	49c60613          	addi	a2,a2,1180 # ffffffffc0204960 <commands+0x818>
ffffffffc02014cc:	0fe00593          	li	a1,254
ffffffffc02014d0:	00003517          	auipc	a0,0x3
ffffffffc02014d4:	4a850513          	addi	a0,a0,1192 # ffffffffc0204978 <commands+0x830>
ffffffffc02014d8:	f83fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(!PageProperty(p0));
ffffffffc02014dc:	00003697          	auipc	a3,0x3
ffffffffc02014e0:	67c68693          	addi	a3,a3,1660 # ffffffffc0204b58 <commands+0xa10>
ffffffffc02014e4:	00003617          	auipc	a2,0x3
ffffffffc02014e8:	47c60613          	addi	a2,a2,1148 # ffffffffc0204960 <commands+0x818>
ffffffffc02014ec:	0f900593          	li	a1,249
ffffffffc02014f0:	00003517          	auipc	a0,0x3
ffffffffc02014f4:	48850513          	addi	a0,a0,1160 # ffffffffc0204978 <commands+0x830>
ffffffffc02014f8:	f63fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02014fc:	00003697          	auipc	a3,0x3
ffffffffc0201500:	77c68693          	addi	a3,a3,1916 # ffffffffc0204c78 <commands+0xb30>
ffffffffc0201504:	00003617          	auipc	a2,0x3
ffffffffc0201508:	45c60613          	addi	a2,a2,1116 # ffffffffc0204960 <commands+0x818>
ffffffffc020150c:	11700593          	li	a1,279
ffffffffc0201510:	00003517          	auipc	a0,0x3
ffffffffc0201514:	46850513          	addi	a0,a0,1128 # ffffffffc0204978 <commands+0x830>
ffffffffc0201518:	f43fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(total == 0);
ffffffffc020151c:	00003697          	auipc	a3,0x3
ffffffffc0201520:	78c68693          	addi	a3,a3,1932 # ffffffffc0204ca8 <commands+0xb60>
ffffffffc0201524:	00003617          	auipc	a2,0x3
ffffffffc0201528:	43c60613          	addi	a2,a2,1084 # ffffffffc0204960 <commands+0x818>
ffffffffc020152c:	12600593          	li	a1,294
ffffffffc0201530:	00003517          	auipc	a0,0x3
ffffffffc0201534:	44850513          	addi	a0,a0,1096 # ffffffffc0204978 <commands+0x830>
ffffffffc0201538:	f23fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(total == nr_free_pages());
ffffffffc020153c:	00003697          	auipc	a3,0x3
ffffffffc0201540:	45468693          	addi	a3,a3,1108 # ffffffffc0204990 <commands+0x848>
ffffffffc0201544:	00003617          	auipc	a2,0x3
ffffffffc0201548:	41c60613          	addi	a2,a2,1052 # ffffffffc0204960 <commands+0x818>
ffffffffc020154c:	0f300593          	li	a1,243
ffffffffc0201550:	00003517          	auipc	a0,0x3
ffffffffc0201554:	42850513          	addi	a0,a0,1064 # ffffffffc0204978 <commands+0x830>
ffffffffc0201558:	f03fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc020155c:	00003697          	auipc	a3,0x3
ffffffffc0201560:	47468693          	addi	a3,a3,1140 # ffffffffc02049d0 <commands+0x888>
ffffffffc0201564:	00003617          	auipc	a2,0x3
ffffffffc0201568:	3fc60613          	addi	a2,a2,1020 # ffffffffc0204960 <commands+0x818>
ffffffffc020156c:	0ba00593          	li	a1,186
ffffffffc0201570:	00003517          	auipc	a0,0x3
ffffffffc0201574:	40850513          	addi	a0,a0,1032 # ffffffffc0204978 <commands+0x830>
...
ffffffffc02016ac:	61868693          	addi	a3,a3,1560 # ffffffffc0204cc0 <commands+0xb78>
ffffffffc02016b0:	00003617          	auipc	a2,0x3
ffffffffc02016b4:	2b060613          	addi	a2,a2,688 # ffffffffc0204960 <commands+0x818>
ffffffffc02016b8:	08300593          	li	a1,131
ffffffffc02016bc:	00003517          	auipc	a0,0x3
ffffffffc02016c0:	2bc50513          	addi	a0,a0,700 # ffffffffc0204978 <commands+0x830>
ffffffffc02016c4:	d97fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(n > 0);
ffffffffc02016c8:	00003697          	auipc	a3,0x3
ffffffffc02016cc:	5f068693          	addi	a3,a3,1520 # ffffffffc0204cb8 <commands+0xb70>
ffffffffc02016d0:	00003617          	auipc	a2,0x3
ffffffffc02016d4:	29060613          	addi	a2,a2,656 # ffffffffc0204960 <commands+0x818>
ffffffffc02016d8:	08000593          	li	a1,128
ffffffffc02016dc:	00003517          	auipc	a0,0x3
ffffffffc02016e0:	29c50513          	addi	a0,a0,668 # ffffffffc0204978 <commands+0x830>
...
ffffffffc020177e:	53e68693          	addi	a3,a3,1342 # ffffffffc0204cb8 <commands+0xb70>
ffffffffc0201782:	00003617          	auipc	a2,0x3
ffffffffc0201786:	1de60613          	addi	a2,a2,478 # ffffffffc0204960 <commands+0x818>
ffffffffc020178a:	06200593          	li	a1,98
ffffffffc020178e:	00003517          	auipc	a0,0x3
ffffffffc0201792:	1ea50513          	addi	a0,a0,490 # ffffffffc0204978 <commands+0x830>
default_alloc_pages(size_t n) {
...
ffffffffc0201850:	49c68693          	addi	a3,a3,1180 # ffffffffc0204ce8 <commands+0xba0>
ffffffffc0201854:	00003617          	auipc	a2,0x3
ffffffffc0201858:	10c60613          	addi	a2,a2,268 # ffffffffc0204960 <commands+0x818>
ffffffffc020185c:	04900593          	li	a1,73
ffffffffc0201860:	00003517          	auipc	a0,0x3
ffffffffc0201864:	11850513          	addi	a0,a0,280 # ffffffffc0204978 <commands+0x830>
ffffffffc0201868:	bf3fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(n > 0);
ffffffffc020186c:	00003697          	auipc	a3,0x3
ffffffffc0201870:	44c68693          	addi	a3,a3,1100 # ffffffffc0204cb8 <commands+0xb70>
ffffffffc0201874:	00003617          	auipc	a2,0x3
ffffffffc0201878:	0ec60613          	addi	a2,a2,236 # ffffffffc0204960 <commands+0x818>
ffffffffc020187c:	04600593          	li	a1,70
ffffffffc0201880:	00003517          	auipc	a0,0x3
ffffffffc0201884:	0f850513          	addi	a0,a0,248 # ffffffffc0204978 <commands+0x830>
...
ffffffffc0201960:	0cc6b683          	ld	a3,204(a3) # ffffffffc0205a28 <nbase>
...
ffffffffc0201990:	3bc60613          	addi	a2,a2,956 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0201994:	07100593          	li	a1,113
ffffffffc0201998:	00003517          	auipc	a0,0x3
ffffffffc020199c:	3d850513          	addi	a0,a0,984 # ffffffffc0204d70 <default_pmm_manager+0x60>
...
ffffffffc0201a7e:	30668693          	addi	a3,a3,774 # ffffffffc0204d80 <default_pmm_manager+0x70>
ffffffffc0201a82:	00003617          	auipc	a2,0x3
ffffffffc0201a86:	ede60613          	addi	a2,a2,-290 # ffffffffc0204960 <commands+0x818>
ffffffffc0201a8a:	06300593          	li	a1,99
ffffffffc0201a8e:	00003517          	auipc	a0,0x3
ffffffffc0201a92:	31250513          	addi	a0,a0,786 # ffffffffc0204da0 <default_pmm_manager+0x90>
...
ffffffffc0201aa0:	31c50513          	addi	a0,a0,796 # ffffffffc0204db8 <default_pmm_manager+0xa8>
{
...
ffffffffc0201ab0:	32450513          	addi	a0,a0,804 # ffffffffc0204dd0 <default_pmm_manager+0xc0>
}
...
ffffffffc0201bd4:	e5853503          	ld	a0,-424(a0) # ffffffffc0205a28 <nbase>
...
ffffffffc0201c32:	1ea60613          	addi	a2,a2,490 # ffffffffc0204e18 <default_pmm_manager+0x108>
ffffffffc0201c36:	06900593          	li	a1,105
ffffffffc0201c3a:	00003517          	auipc	a0,0x3
ffffffffc0201c3e:	13650513          	addi	a0,a0,310 # ffffffffc0204d70 <default_pmm_manager+0x60>
...
ffffffffc0201c4c:	1a860613          	addi	a2,a2,424 # ffffffffc0204df0 <default_pmm_manager+0xe0>
ffffffffc0201c50:	07700593          	li	a1,119
ffffffffc0201c54:	00003517          	auipc	a0,0x3
ffffffffc0201c58:	11c50513          	addi	a0,a0,284 # ffffffffc0204d70 <default_pmm_manager+0x60>
...
ffffffffc0201c66:	1b660613          	addi	a2,a2,438 # ffffffffc0204e18 <default_pmm_manager+0x108>
ffffffffc0201c6a:	06900593          	li	a1,105
ffffffffc0201c6e:	00003517          	auipc	a0,0x3
ffffffffc0201c72:	10250513          	addi	a0,a0,258 # ffffffffc0204d70 <default_pmm_manager+0x60>
pa2page(uintptr_t pa)
...
ffffffffc0201c82:	1ba60613          	addi	a2,a2,442 # ffffffffc0204e38 <default_pmm_manager+0x128>
ffffffffc0201c86:	07f00593          	li	a1,127
ffffffffc0201c8a:	00003517          	auipc	a0,0x3
ffffffffc0201c8e:	0e650513          	addi	a0,a0,230 # ffffffffc0204d70 <default_pmm_manager+0x60>
pte2page(pte_t pte)
...
ffffffffc0201de8:	0a4020ef          	jal	ra,ffffffffc0203e8c <memset>
    return page - pages + nbase;
...
ffffffffc0201e8a:	002020ef          	jal	ra,ffffffffc0203e8c <memset>
    return page - pages + nbase;
...
ffffffffc0201f18:	e3460613          	addi	a2,a2,-460 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0201f1c:	0fb00593          	li	a1,251
ffffffffc0201f20:	00003517          	auipc	a0,0x3
ffffffffc0201f24:	f4050513          	addi	a0,a0,-192 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0201f28:	d32fe0ef          	jal	ra,ffffffffc020045a <__panic>
    pde_t *pdep0 = &((pte_t *)KADDR(PDE_ADDR(*pdep1)))[PDX0(la)];
ffffffffc0201f2c:	00003617          	auipc	a2,0x3
ffffffffc0201f30:	e1c60613          	addi	a2,a2,-484 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0201f34:	0ee00593          	li	a1,238
ffffffffc0201f38:	00003517          	auipc	a0,0x3
ffffffffc0201f3c:	f2850513          	addi	a0,a0,-216 # ffffffffc0204e60 <default_pmm_manager+0x150>
...
ffffffffc0201f4a:	e0260613          	addi	a2,a2,-510 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0201f4e:	0eb00593          	li	a1,235
ffffffffc0201f52:	00003517          	auipc	a0,0x3
ffffffffc0201f56:	f0e50513          	addi	a0,a0,-242 # ffffffffc0204e60 <default_pmm_manager+0x150>
...
ffffffffc0201f64:	de860613          	addi	a2,a2,-536 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0201f68:	0f800593          	li	a1,248
ffffffffc0201f6c:	00003517          	auipc	a0,0x3
ffffffffc0201f70:	ef450513          	addi	a0,a0,-268 # ffffffffc0204e60 <default_pmm_manager+0x150>
...
ffffffffc0202162:	bb278793          	addi	a5,a5,-1102 # ffffffffc0204d10 <default_pmm_manager>
...
ffffffffc0202170:	d0450513          	addi	a0,a0,-764 # ffffffffc0204e70 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc02021c4:	ce850513          	addi	a0,a0,-792 # ffffffffc0204ea8 <default_pmm_manager+0x198>
...
ffffffffc02021dc:	ce850513          	addi	a0,a0,-792 # ffffffffc0204ec0 <default_pmm_manager+0x1b0>
...
ffffffffc0202264:	c8850513          	addi	a0,a0,-888 # ffffffffc0204ee8 <default_pmm_manager+0x1d8>
...
ffffffffc0202280:	c8450513          	addi	a0,a0,-892 # ffffffffc0204f00 <default_pmm_manager+0x1f0>
...
ffffffffc0202536:	cf650513          	addi	a0,a0,-778 # ffffffffc0205228 <default_pmm_manager+0x518>
...
ffffffffc02025fa:	d7a58593          	addi	a1,a1,-646 # ffffffffc0205370 <default_pmm_manager+0x660>
ffffffffc02025fe:	10000513          	li	a0,256
ffffffffc0202602:	01f010ef          	jal	ra,ffffffffc0203e20 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202606:	10040593          	addi	a1,s0,256
ffffffffc020260a:	10000513          	li	a0,256
ffffffffc020260e:	025010ef          	jal	ra,ffffffffc0203e32 <strcmp>
...
ffffffffc0202640:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202644:	7a6010ef          	jal	ra,ffffffffc0203dea <strlen>
...
ffffffffc0202708:	ce450513          	addi	a0,a0,-796 # ffffffffc02053e8 <default_pmm_manager+0x6d8>
...
ffffffffc0202870:	4dc60613          	addi	a2,a2,1244 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0202874:	1a400593          	li	a1,420
ffffffffc0202878:	00002517          	auipc	a0,0x2
ffffffffc020287c:	5e850513          	addi	a0,a0,1512 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202880:	bdbfd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(PTE_ADDR(*ptep) == i);
ffffffffc0202884:	00003697          	auipc	a3,0x3
ffffffffc0202888:	a0468693          	addi	a3,a3,-1532 # ffffffffc0205288 <default_pmm_manager+0x578>
ffffffffc020288c:	00002617          	auipc	a2,0x2
ffffffffc0202890:	0d460613          	addi	a2,a2,212 # ffffffffc0204960 <commands+0x818>
ffffffffc0202894:	1a500593          	li	a1,421
ffffffffc0202898:	00002517          	auipc	a0,0x2
ffffffffc020289c:	5c850513          	addi	a0,a0,1480 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc02028a0:	bbbfd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert((ptep = get_pte(boot_pgdir_va, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02028a4:	00003697          	auipc	a3,0x3
ffffffffc02028a8:	9a468693          	addi	a3,a3,-1628 # ffffffffc0205248 <default_pmm_manager+0x538>
ffffffffc02028ac:	00002617          	auipc	a2,0x2
ffffffffc02028b0:	0b460613          	addi	a2,a2,180 # ffffffffc0204960 <commands+0x818>
ffffffffc02028b4:	1a400593          	li	a1,420
ffffffffc02028b8:	00002517          	auipc	a0,0x2
ffffffffc02028bc:	5a850513          	addi	a0,a0,1448 # ffffffffc0204e60 <default_pmm_manager+0x150>
...
ffffffffc02028d0:	77468693          	addi	a3,a3,1908 # ffffffffc0205040 <default_pmm_manager+0x330>
ffffffffc02028d4:	00002617          	auipc	a2,0x2
ffffffffc02028d8:	08c60613          	addi	a2,a2,140 # ffffffffc0204960 <commands+0x818>
ffffffffc02028dc:	17400593          	li	a1,372
ffffffffc02028e0:	00002517          	auipc	a0,0x2
ffffffffc02028e4:	58050513          	addi	a0,a0,1408 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc02028e8:	b73fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(get_page(boot_pgdir_va, 0x0, NULL) == NULL);
ffffffffc02028ec:	00002697          	auipc	a3,0x2
ffffffffc02028f0:	69468693          	addi	a3,a3,1684 # ffffffffc0204f80 <default_pmm_manager+0x270>
ffffffffc02028f4:	00002617          	auipc	a2,0x2
ffffffffc02028f8:	06c60613          	addi	a2,a2,108 # ffffffffc0204960 <commands+0x818>
ffffffffc02028fc:	16700593          	li	a1,359
ffffffffc0202900:	00002517          	auipc	a0,0x2
ffffffffc0202904:	56050513          	addi	a0,a0,1376 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202908:	b53fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(boot_pgdir_va != NULL && (uint32_t)PGOFF(boot_pgdir_va) == 0);
ffffffffc020290c:	00002697          	auipc	a3,0x2
ffffffffc0202910:	63468693          	addi	a3,a3,1588 # ffffffffc0204f40 <default_pmm_manager+0x230>
ffffffffc0202914:	00002617          	auipc	a2,0x2
ffffffffc0202918:	04c60613          	addi	a2,a2,76 # ffffffffc0204960 <commands+0x818>
ffffffffc020291c:	16600593          	li	a1,358
ffffffffc0202920:	00002517          	auipc	a0,0x2
ffffffffc0202924:	54050513          	addi	a0,a0,1344 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202928:	b33fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020292c:	00002697          	auipc	a3,0x2
ffffffffc0202930:	5f468693          	addi	a3,a3,1524 # ffffffffc0204f20 <default_pmm_manager+0x210>
ffffffffc0202934:	00002617          	auipc	a2,0x2
ffffffffc0202938:	02c60613          	addi	a2,a2,44 # ffffffffc0204960 <commands+0x818>
ffffffffc020293c:	16500593          	li	a1,357
ffffffffc0202940:	00002517          	auipc	a0,0x2
ffffffffc0202944:	52050513          	addi	a0,a0,1312 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202948:	b13fd0ef          	jal	ra,ffffffffc020045a <__panic>
    return KADDR(page2pa(page));
ffffffffc020294c:	00002617          	auipc	a2,0x2
ffffffffc0202950:	3fc60613          	addi	a2,a2,1020 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0202954:	07100593          	li	a1,113
ffffffffc0202958:	00002517          	auipc	a0,0x2
ffffffffc020295c:	41850513          	addi	a0,a0,1048 # ffffffffc0204d70 <default_pmm_manager+0x60>
ffffffffc0202960:	afbfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(pde2page(boot_pgdir_va[0])) == 1);
ffffffffc0202964:	00003697          	auipc	a3,0x3
ffffffffc0202968:	86c68693          	addi	a3,a3,-1940 # ffffffffc02051d0 <default_pmm_manager+0x4c0>
ffffffffc020296c:	00002617          	auipc	a2,0x2
ffffffffc0202970:	ff460613          	addi	a2,a2,-12 # ffffffffc0204960 <commands+0x818>
ffffffffc0202974:	18d00593          	li	a1,397
ffffffffc0202978:	00002517          	auipc	a0,0x2
ffffffffc020297c:	4e850513          	addi	a0,a0,1256 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202980:	adbfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202984:	00003697          	auipc	a3,0x3
ffffffffc0202988:	80468693          	addi	a3,a3,-2044 # ffffffffc0205188 <default_pmm_manager+0x478>
ffffffffc020298c:	00002617          	auipc	a2,0x2
ffffffffc0202990:	fd460613          	addi	a2,a2,-44 # ffffffffc0204960 <commands+0x818>
ffffffffc0202994:	18b00593          	li	a1,395
ffffffffc0202998:	00002517          	auipc	a0,0x2
ffffffffc020299c:	4c850513          	addi	a0,a0,1224 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc02029a0:	abbfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02029a4:	00003697          	auipc	a3,0x3
ffffffffc02029a8:	81468693          	addi	a3,a3,-2028 # ffffffffc02051b8 <default_pmm_manager+0x4a8>
ffffffffc02029ac:	00002617          	auipc	a2,0x2
ffffffffc02029b0:	fb460613          	addi	a2,a2,-76 # ffffffffc0204960 <commands+0x818>
ffffffffc02029b4:	18a00593          	li	a1,394
ffffffffc02029b8:	00002517          	auipc	a0,0x2
ffffffffc02029bc:	4a850513          	addi	a0,a0,1192 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc02029c0:	a9bfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(boot_pgdir_va[0] == 0);
ffffffffc02029c4:	00003697          	auipc	a3,0x3
ffffffffc02029c8:	8dc68693          	addi	a3,a3,-1828 # ffffffffc02052a0 <default_pmm_manager+0x590>
ffffffffc02029cc:	00002617          	auipc	a2,0x2
ffffffffc02029d0:	f9460613          	addi	a2,a2,-108 # ffffffffc0204960 <commands+0x818>
ffffffffc02029d4:	1a800593          	li	a1,424
ffffffffc02029d8:	00002517          	auipc	a0,0x2
ffffffffc02029dc:	48850513          	addi	a0,a0,1160 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc02029e0:	a7bfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free_store == nr_free_pages());
ffffffffc02029e4:	00003697          	auipc	a3,0x3
ffffffffc02029e8:	81c68693          	addi	a3,a3,-2020 # ffffffffc0205200 <default_pmm_manager+0x4f0>
ffffffffc02029ec:	00002617          	auipc	a2,0x2
ffffffffc02029f0:	f7460613          	addi	a2,a2,-140 # ffffffffc0204960 <commands+0x818>
ffffffffc02029f4:	19500593          	li	a1,405
ffffffffc02029f8:	00002517          	auipc	a0,0x2
ffffffffc02029fc:	46850513          	addi	a0,a0,1128 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202a00:	a5bfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202a04:	00003697          	auipc	a3,0x3
ffffffffc0202a08:	8f468693          	addi	a3,a3,-1804 # ffffffffc02052f8 <default_pmm_manager+0x5e8>
ffffffffc0202a0c:	00002617          	auipc	a2,0x2
ffffffffc0202a10:	f5460613          	addi	a2,a2,-172 # ffffffffc0204960 <commands+0x818>
ffffffffc0202a14:	1ad00593          	li	a1,429
ffffffffc0202a18:	00002517          	auipc	a0,0x2
ffffffffc0202a1c:	44850513          	addi	a0,a0,1096 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202a20:	a3bfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202a24:	00003697          	auipc	a3,0x3
ffffffffc0202a28:	89468693          	addi	a3,a3,-1900 # ffffffffc02052b8 <default_pmm_manager+0x5a8>
ffffffffc0202a2c:	00002617          	auipc	a2,0x2
ffffffffc0202a30:	f3460613          	addi	a2,a2,-204 # ffffffffc0204960 <commands+0x818>
ffffffffc0202a34:	1ac00593          	li	a1,428
ffffffffc0202a38:	00002517          	auipc	a0,0x2
ffffffffc0202a3c:	42850513          	addi	a0,a0,1064 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202a40:	a1bfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202a44:	00002697          	auipc	a3,0x2
ffffffffc0202a48:	74468693          	addi	a3,a3,1860 # ffffffffc0205188 <default_pmm_manager+0x478>
ffffffffc0202a4c:	00002617          	auipc	a2,0x2
ffffffffc0202a50:	f1460613          	addi	a2,a2,-236 # ffffffffc0204960 <commands+0x818>
ffffffffc0202a54:	18700593          	li	a1,391
ffffffffc0202a58:	00002517          	auipc	a0,0x2
ffffffffc0202a5c:	40850513          	addi	a0,a0,1032 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202a60:	9fbfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202a64:	00002697          	auipc	a3,0x2
ffffffffc0202a68:	5c468693          	addi	a3,a3,1476 # ffffffffc0205028 <default_pmm_manager+0x318>
ffffffffc0202a6c:	00002617          	auipc	a2,0x2
ffffffffc0202a70:	ef460613          	addi	a2,a2,-268 # ffffffffc0204960 <commands+0x818>
ffffffffc0202a74:	18600593          	li	a1,390
ffffffffc0202a78:	00002517          	auipc	a0,0x2
ffffffffc0202a7c:	3e850513          	addi	a0,a0,1000 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202a80:	9dbfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc0202a84:	00002697          	auipc	a3,0x2
ffffffffc0202a88:	71c68693          	addi	a3,a3,1820 # ffffffffc02051a0 <default_pmm_manager+0x490>
ffffffffc0202a8c:	00002617          	auipc	a2,0x2
ffffffffc0202a90:	ed460613          	addi	a2,a2,-300 # ffffffffc0204960 <commands+0x818>
ffffffffc0202a94:	18300593          	li	a1,387
ffffffffc0202a98:	00002517          	auipc	a0,0x2
ffffffffc0202a9c:	3c850513          	addi	a0,a0,968 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202aa0:	9bbfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202aa4:	00002697          	auipc	a3,0x2
ffffffffc0202aa8:	56c68693          	addi	a3,a3,1388 # ffffffffc0205010 <default_pmm_manager+0x300>
ffffffffc0202aac:	00002617          	auipc	a2,0x2
ffffffffc0202ab0:	eb460613          	addi	a2,a2,-332 # ffffffffc0204960 <commands+0x818>
ffffffffc0202ab4:	18200593          	li	a1,386
ffffffffc0202ab8:	00002517          	auipc	a0,0x2
ffffffffc0202abc:	3a850513          	addi	a0,a0,936 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202ac0:	99bfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, PGSIZE, 0)) != NULL);
ffffffffc0202ac4:	00002697          	auipc	a3,0x2
ffffffffc0202ac8:	5ec68693          	addi	a3,a3,1516 # ffffffffc02050b0 <default_pmm_manager+0x3a0>
ffffffffc0202acc:	00002617          	auipc	a2,0x2
ffffffffc0202ad0:	e9460613          	addi	a2,a2,-364 # ffffffffc0204960 <commands+0x818>
ffffffffc0202ad4:	18100593          	li	a1,385
ffffffffc0202ad8:	00002517          	auipc	a0,0x2
ffffffffc0202adc:	38850513          	addi	a0,a0,904 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202ae0:	97bfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202ae4:	00002697          	auipc	a3,0x2
ffffffffc0202ae8:	6a468693          	addi	a3,a3,1700 # ffffffffc0205188 <default_pmm_manager+0x478>
ffffffffc0202aec:	00002617          	auipc	a2,0x2
ffffffffc0202af0:	e7460613          	addi	a2,a2,-396 # ffffffffc0204960 <commands+0x818>
ffffffffc0202af4:	18000593          	li	a1,384
ffffffffc0202af8:	00002517          	auipc	a0,0x2
ffffffffc0202afc:	36850513          	addi	a0,a0,872 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202b00:	95bfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0202b04:	00002697          	auipc	a3,0x2
ffffffffc0202b08:	66c68693          	addi	a3,a3,1644 # ffffffffc0205170 <default_pmm_manager+0x460>
ffffffffc0202b0c:	00002617          	auipc	a2,0x2
ffffffffc0202b10:	e5460613          	addi	a2,a2,-428 # ffffffffc0204960 <commands+0x818>
ffffffffc0202b14:	17f00593          	li	a1,383
ffffffffc0202b18:	00002517          	auipc	a0,0x2
ffffffffc0202b1c:	34850513          	addi	a0,a0,840 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202b20:	93bfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p1, PGSIZE, 0) == 0);
ffffffffc0202b24:	00002697          	auipc	a3,0x2
ffffffffc0202b28:	61c68693          	addi	a3,a3,1564 # ffffffffc0205140 <default_pmm_manager+0x430>
ffffffffc0202b2c:	00002617          	auipc	a2,0x2
ffffffffc0202b30:	e3460613          	addi	a2,a2,-460 # ffffffffc0204960 <commands+0x818>
ffffffffc0202b34:	17e00593          	li	a1,382
ffffffffc0202b38:	00002517          	auipc	a0,0x2
ffffffffc0202b3c:	32850513          	addi	a0,a0,808 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202b40:	91bfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 1);
ffffffffc0202b44:	00002697          	auipc	a3,0x2
ffffffffc0202b48:	5e468693          	addi	a3,a3,1508 # ffffffffc0205128 <default_pmm_manager+0x418>
ffffffffc0202b4c:	00002617          	auipc	a2,0x2
ffffffffc0202b50:	e1460613          	addi	a2,a2,-492 # ffffffffc0204960 <commands+0x818>
ffffffffc0202b54:	17c00593          	li	a1,380
ffffffffc0202b58:	00002517          	auipc	a0,0x2
ffffffffc0202b5c:	30850513          	addi	a0,a0,776 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202b60:	8fbfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(boot_pgdir_va[0] & PTE_U);
ffffffffc0202b64:	00002697          	auipc	a3,0x2
ffffffffc0202b68:	5a468693          	addi	a3,a3,1444 # ffffffffc0205108 <default_pmm_manager+0x3f8>
ffffffffc0202b6c:	00002617          	auipc	a2,0x2
ffffffffc0202b70:	df460613          	addi	a2,a2,-524 # ffffffffc0204960 <commands+0x818>
ffffffffc0202b74:	17b00593          	li	a1,379
ffffffffc0202b78:	00002517          	auipc	a0,0x2
ffffffffc0202b7c:	2e850513          	addi	a0,a0,744 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202b80:	8dbfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(*ptep & PTE_W);
ffffffffc0202b84:	00002697          	auipc	a3,0x2
ffffffffc0202b88:	57468693          	addi	a3,a3,1396 # ffffffffc02050f8 <default_pmm_manager+0x3e8>
ffffffffc0202b8c:	00002617          	auipc	a2,0x2
ffffffffc0202b90:	dd460613          	addi	a2,a2,-556 # ffffffffc0204960 <commands+0x818>
ffffffffc0202b94:	17a00593          	li	a1,378
ffffffffc0202b98:	00002517          	auipc	a0,0x2
ffffffffc0202b9c:	2c850513          	addi	a0,a0,712 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202ba0:	8bbfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(*ptep & PTE_U);
ffffffffc0202ba4:	00002697          	auipc	a3,0x2
ffffffffc0202ba8:	54468693          	addi	a3,a3,1348 # ffffffffc02050e8 <default_pmm_manager+0x3d8>
ffffffffc0202bac:	00002617          	auipc	a2,0x2
ffffffffc0202bb0:	db460613          	addi	a2,a2,-588 # ffffffffc0204960 <commands+0x818>
ffffffffc0202bb4:	17900593          	li	a1,377
ffffffffc0202bb8:	00002517          	auipc	a0,0x2
ffffffffc0202bbc:	2a850513          	addi	a0,a0,680 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202bc0:	89bfd0ef          	jal	ra,ffffffffc020045a <__panic>
        panic("DTB memory info not available");
ffffffffc0202bc4:	00002617          	auipc	a2,0x2
ffffffffc0202bc8:	2c460613          	addi	a2,a2,708 # ffffffffc0204e88 <default_pmm_manager+0x178>
ffffffffc0202bcc:	06400593          	li	a1,100
ffffffffc0202bd0:	00002517          	auipc	a0,0x2
ffffffffc0202bd4:	29050513          	addi	a0,a0,656 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202bd8:	883fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free_store == nr_free_pages());
ffffffffc0202bdc:	00002697          	auipc	a3,0x2
ffffffffc0202be0:	62468693          	addi	a3,a3,1572 # ffffffffc0205200 <default_pmm_manager+0x4f0>
ffffffffc0202be4:	00002617          	auipc	a2,0x2
ffffffffc0202be8:	d7c60613          	addi	a2,a2,-644 # ffffffffc0204960 <commands+0x818>
ffffffffc0202bec:	1bf00593          	li	a1,447
ffffffffc0202bf0:	00002517          	auipc	a0,0x2
ffffffffc0202bf4:	27050513          	addi	a0,a0,624 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202bf8:	863fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, PGSIZE, 0)) != NULL);
ffffffffc0202bfc:	00002697          	auipc	a3,0x2
ffffffffc0202c00:	4b468693          	addi	a3,a3,1204 # ffffffffc02050b0 <default_pmm_manager+0x3a0>
ffffffffc0202c04:	00002617          	auipc	a2,0x2
ffffffffc0202c08:	d5c60613          	addi	a2,a2,-676 # ffffffffc0204960 <commands+0x818>
ffffffffc0202c0c:	17800593          	li	a1,376
ffffffffc0202c10:	00002517          	auipc	a0,0x2
ffffffffc0202c14:	25050513          	addi	a0,a0,592 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202c18:	843fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202c1c:	00002697          	auipc	a3,0x2
ffffffffc0202c20:	45468693          	addi	a3,a3,1108 # ffffffffc0205070 <default_pmm_manager+0x360>
ffffffffc0202c24:	00002617          	auipc	a2,0x2
ffffffffc0202c28:	d3c60613          	addi	a2,a2,-708 # ffffffffc0204960 <commands+0x818>
ffffffffc0202c2c:	17700593          	li	a1,375
ffffffffc0202c30:	00002517          	auipc	a0,0x2
ffffffffc0202c34:	23050513          	addi	a0,a0,560 # ffffffffc0204e60 <default_pmm_manager+0x150>
...
ffffffffc0202c42:	10a60613          	addi	a2,a2,266 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0202c46:	17300593          	li	a1,371
ffffffffc0202c4a:	00002517          	auipc	a0,0x2
ffffffffc0202c4e:	21650513          	addi	a0,a0,534 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202c52:	809fd0ef          	jal	ra,ffffffffc020045a <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir_va[0]));
ffffffffc0202c56:	00002617          	auipc	a2,0x2
ffffffffc0202c5a:	0f260613          	addi	a2,a2,242 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0202c5e:	17200593          	li	a1,370
ffffffffc0202c62:	00002517          	auipc	a0,0x2
ffffffffc0202c66:	1fe50513          	addi	a0,a0,510 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202c6a:	ff0fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202c6e:	00002697          	auipc	a3,0x2
ffffffffc0202c72:	3ba68693          	addi	a3,a3,954 # ffffffffc0205028 <default_pmm_manager+0x318>
ffffffffc0202c76:	00002617          	auipc	a2,0x2
ffffffffc0202c7a:	cea60613          	addi	a2,a2,-790 # ffffffffc0204960 <commands+0x818>
ffffffffc0202c7e:	17000593          	li	a1,368
ffffffffc0202c82:	00002517          	auipc	a0,0x2
ffffffffc0202c86:	1de50513          	addi	a0,a0,478 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202c8a:	fd0fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202c8e:	00002697          	auipc	a3,0x2
ffffffffc0202c92:	38268693          	addi	a3,a3,898 # ffffffffc0205010 <default_pmm_manager+0x300>
ffffffffc0202c96:	00002617          	auipc	a2,0x2
ffffffffc0202c9a:	cca60613          	addi	a2,a2,-822 # ffffffffc0204960 <commands+0x818>
ffffffffc0202c9e:	16f00593          	li	a1,367
ffffffffc0202ca2:	00002517          	auipc	a0,0x2
ffffffffc0202ca6:	1be50513          	addi	a0,a0,446 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202caa:	fb0fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202cae:	00002697          	auipc	a3,0x2
ffffffffc0202cb2:	71268693          	addi	a3,a3,1810 # ffffffffc02053c0 <default_pmm_manager+0x6b0>
ffffffffc0202cb6:	00002617          	auipc	a2,0x2
ffffffffc0202cba:	caa60613          	addi	a2,a2,-854 # ffffffffc0204960 <commands+0x818>
ffffffffc0202cbe:	1b600593          	li	a1,438
ffffffffc0202cc2:	00002517          	auipc	a0,0x2
ffffffffc0202cc6:	19e50513          	addi	a0,a0,414 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202cca:	f90fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202cce:	00002697          	auipc	a3,0x2
ffffffffc0202cd2:	6ba68693          	addi	a3,a3,1722 # ffffffffc0205388 <default_pmm_manager+0x678>
ffffffffc0202cd6:	00002617          	auipc	a2,0x2
ffffffffc0202cda:	c8a60613          	addi	a2,a2,-886 # ffffffffc0204960 <commands+0x818>
ffffffffc0202cde:	1b300593          	li	a1,435
ffffffffc0202ce2:	00002517          	auipc	a0,0x2
ffffffffc0202ce6:	17e50513          	addi	a0,a0,382 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202cea:	f70fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202cee:	00002697          	auipc	a3,0x2
ffffffffc0202cf2:	66a68693          	addi	a3,a3,1642 # ffffffffc0205358 <default_pmm_manager+0x648>
ffffffffc0202cf6:	00002617          	auipc	a2,0x2
ffffffffc0202cfa:	c6a60613          	addi	a2,a2,-918 # ffffffffc0204960 <commands+0x818>
ffffffffc0202cfe:	1af00593          	li	a1,431
ffffffffc0202d02:	00002517          	auipc	a0,0x2
ffffffffc0202d06:	15e50513          	addi	a0,a0,350 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202d0a:	f50fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc0202d0e:	00002697          	auipc	a3,0x2
ffffffffc0202d12:	60268693          	addi	a3,a3,1538 # ffffffffc0205310 <default_pmm_manager+0x600>
ffffffffc0202d16:	00002617          	auipc	a2,0x2
ffffffffc0202d1a:	c4a60613          	addi	a2,a2,-950 # ffffffffc0204960 <commands+0x818>
ffffffffc0202d1e:	1ae00593          	li	a1,430
ffffffffc0202d22:	00002517          	auipc	a0,0x2
ffffffffc0202d26:	13e50513          	addi	a0,a0,318 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202d2a:	f30fd0ef          	jal	ra,ffffffffc020045a <__panic>
    boot_pgdir_pa = PADDR(boot_pgdir_va);
ffffffffc0202d2e:	00002617          	auipc	a2,0x2
ffffffffc0202d32:	0c260613          	addi	a2,a2,194 # ffffffffc0204df0 <default_pmm_manager+0xe0>
ffffffffc0202d36:	0cb00593          	li	a1,203
ffffffffc0202d3a:	00002517          	auipc	a0,0x2
ffffffffc0202d3e:	12650513          	addi	a0,a0,294 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202d42:	f18fd0ef          	jal	ra,ffffffffc020045a <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc0202d46:	00002617          	auipc	a2,0x2
ffffffffc0202d4a:	0aa60613          	addi	a2,a2,170 # ffffffffc0204df0 <default_pmm_manager+0xe0>
ffffffffc0202d4e:	08000593          	li	a1,128
ffffffffc0202d52:	00002517          	auipc	a0,0x2
ffffffffc0202d56:	10e50513          	addi	a0,a0,270 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202d5a:	f00fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, 0x0, 0)) != NULL);
ffffffffc0202d5e:	00002697          	auipc	a3,0x2
ffffffffc0202d62:	28268693          	addi	a3,a3,642 # ffffffffc0204fe0 <default_pmm_manager+0x2d0>
ffffffffc0202d66:	00002617          	auipc	a2,0x2
ffffffffc0202d6a:	bfa60613          	addi	a2,a2,-1030 # ffffffffc0204960 <commands+0x818>
ffffffffc0202d6e:	16e00593          	li	a1,366
ffffffffc0202d72:	00002517          	auipc	a0,0x2
ffffffffc0202d76:	0ee50513          	addi	a0,a0,238 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202d7a:	ee0fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p1, 0x0, 0) == 0);
ffffffffc0202d7e:	00002697          	auipc	a3,0x2
ffffffffc0202d82:	23268693          	addi	a3,a3,562 # ffffffffc0204fb0 <default_pmm_manager+0x2a0>
ffffffffc0202d86:	00002617          	auipc	a2,0x2
ffffffffc0202d8a:	bda60613          	addi	a2,a2,-1062 # ffffffffc0204960 <commands+0x818>
ffffffffc0202d8e:	16b00593          	li	a1,363
ffffffffc0202d92:	00002517          	auipc	a0,0x2
ffffffffc0202d96:	0ce50513          	addi	a0,a0,206 # ffffffffc0204e60 <default_pmm_manager+0x150>
...
ffffffffc0202da4:	66868693          	addi	a3,a3,1640 # ffffffffc0205408 <default_pmm_manager+0x6f8>
ffffffffc0202da8:	00002617          	auipc	a2,0x2
ffffffffc0202dac:	bb860613          	addi	a2,a2,-1096 # ffffffffc0204960 <commands+0x818>
ffffffffc0202db0:	08800593          	li	a1,136
ffffffffc0202db4:	00002517          	auipc	a0,0x2
ffffffffc0202db8:	67450513          	addi	a0,a0,1652 # ffffffffc0205428 <default_pmm_manager+0x718>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next)
...
ffffffffc0202e76:	5c668693          	addi	a3,a3,1478 # ffffffffc0205438 <default_pmm_manager+0x728>
ffffffffc0202e7a:	00002617          	auipc	a2,0x2
ffffffffc0202e7e:	ae660613          	addi	a2,a2,-1306 # ffffffffc0204960 <commands+0x818>
ffffffffc0202e82:	08e00593          	li	a1,142
ffffffffc0202e86:	00002517          	auipc	a0,0x2
ffffffffc0202e8a:	5a250513          	addi	a0,a0,1442 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc0202e8e:	dccfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0202e92:	00002697          	auipc	a3,0x2
ffffffffc0202e96:	5e668693          	addi	a3,a3,1510 # ffffffffc0205478 <default_pmm_manager+0x768>
ffffffffc0202e9a:	00002617          	auipc	a2,0x2
ffffffffc0202e9e:	ac660613          	addi	a2,a2,-1338 # ffffffffc0204960 <commands+0x818>
ffffffffc0202ea2:	08700593          	li	a1,135
ffffffffc0202ea6:	00002517          	auipc	a0,0x2
ffffffffc0202eaa:	58250513          	addi	a0,a0,1410 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc0202eae:	dacfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0202eb2:	00002697          	auipc	a3,0x2
ffffffffc0202eb6:	5a668693          	addi	a3,a3,1446 # ffffffffc0205458 <default_pmm_manager+0x748>
ffffffffc0202eba:	00002617          	auipc	a2,0x2
ffffffffc0202ebe:	aa660613          	addi	a2,a2,-1370 # ffffffffc0204960 <commands+0x818>
ffffffffc0202ec2:	08600593          	li	a1,134
ffffffffc0202ec6:	00002517          	auipc	a0,0x2
ffffffffc0202eca:	56250513          	addi	a0,a0,1378 # ffffffffc0205428 <default_pmm_manager+0x718>
...
ffffffffc0202f30:	6e468693          	addi	a3,a3,1764 # ffffffffc0205610 <default_pmm_manager+0x900>
ffffffffc0202f34:	00002617          	auipc	a2,0x2
ffffffffc0202f38:	a2c60613          	addi	a2,a2,-1492 # ffffffffc0204960 <commands+0x818>
ffffffffc0202f3c:	0da00593          	li	a1,218
ffffffffc0202f40:	00002517          	auipc	a0,0x2
ffffffffc0202f44:	4e850513          	addi	a0,a0,1256 # ffffffffc0205428 <default_pmm_manager+0x718>
...
ffffffffc0202f7e:	69668693          	addi	a3,a3,1686 # ffffffffc0205610 <default_pmm_manager+0x900>
ffffffffc0202f82:	00002617          	auipc	a2,0x2
ffffffffc0202f86:	9de60613          	addi	a2,a2,-1570 # ffffffffc0204960 <commands+0x818>
ffffffffc0202f8a:	0e100593          	li	a1,225
ffffffffc0202f8e:	00002517          	auipc	a0,0x2
ffffffffc0202f92:	49a50513          	addi	a0,a0,1178 # ffffffffc0205428 <default_pmm_manager+0x718>
...
ffffffffc0203052:	54a50513          	addi	a0,a0,1354 # ffffffffc0205598 <default_pmm_manager+0x888>
ffffffffc0203056:	93efd0ef          	jal	ra,ffffffffc0200194 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc020305a:	00002697          	auipc	a3,0x2
ffffffffc020305e:	56668693          	addi	a3,a3,1382 # ffffffffc02055c0 <default_pmm_manager+0x8b0>
ffffffffc0203062:	00002617          	auipc	a2,0x2
ffffffffc0203066:	8fe60613          	addi	a2,a2,-1794 # ffffffffc0204960 <commands+0x818>
ffffffffc020306a:	10700593          	li	a1,263
ffffffffc020306e:	00002517          	auipc	a0,0x2
ffffffffc0203072:	3ba50513          	addi	a0,a0,954 # ffffffffc0205428 <default_pmm_manager+0x718>
...
ffffffffc02030a4:	53850513          	addi	a0,a0,1336 # ffffffffc02055d8 <default_pmm_manager+0x8c8>
...
ffffffffc02030be:	53e50513          	addi	a0,a0,1342 # ffffffffc02055f8 <default_pmm_manager+0x8e8>
}
...
ffffffffc02030cc:	3e868693          	addi	a3,a3,1000 # ffffffffc02054b0 <default_pmm_manager+0x7a0>
ffffffffc02030d0:	00002617          	auipc	a2,0x2
ffffffffc02030d4:	89060613          	addi	a2,a2,-1904 # ffffffffc0204960 <commands+0x818>
ffffffffc02030d8:	0eb00593          	li	a1,235
ffffffffc02030dc:	00002517          	auipc	a0,0x2
ffffffffc02030e0:	34c50513          	addi	a0,a0,844 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc02030e4:	b76fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma1->vm_start == i && vma1->vm_end == i + 2);
ffffffffc02030e8:	00002697          	auipc	a3,0x2
ffffffffc02030ec:	45068693          	addi	a3,a3,1104 # ffffffffc0205538 <default_pmm_manager+0x828>
ffffffffc02030f0:	00002617          	auipc	a2,0x2
ffffffffc02030f4:	87060613          	addi	a2,a2,-1936 # ffffffffc0204960 <commands+0x818>
ffffffffc02030f8:	0fc00593          	li	a1,252
ffffffffc02030fc:	00002517          	auipc	a0,0x2
ffffffffc0203100:	32c50513          	addi	a0,a0,812 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc0203104:	b56fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma2->vm_start == i && vma2->vm_end == i + 2);
ffffffffc0203108:	00002697          	auipc	a3,0x2
ffffffffc020310c:	46068693          	addi	a3,a3,1120 # ffffffffc0205568 <default_pmm_manager+0x858>
ffffffffc0203110:	00002617          	auipc	a2,0x2
ffffffffc0203114:	85060613          	addi	a2,a2,-1968 # ffffffffc0204960 <commands+0x818>
ffffffffc0203118:	0fd00593          	li	a1,253
ffffffffc020311c:	00002517          	auipc	a0,0x2
ffffffffc0203120:	30c50513          	addi	a0,a0,780 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc0203124:	b36fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203128:	00002697          	auipc	a3,0x2
ffffffffc020312c:	37068693          	addi	a3,a3,880 # ffffffffc0205498 <default_pmm_manager+0x788>
ffffffffc0203130:	00002617          	auipc	a2,0x2
ffffffffc0203134:	83060613          	addi	a2,a2,-2000 # ffffffffc0204960 <commands+0x818>
ffffffffc0203138:	0e900593          	li	a1,233
ffffffffc020313c:	00002517          	auipc	a0,0x2
ffffffffc0203140:	2ec50513          	addi	a0,a0,748 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc0203144:	b16fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma2 != NULL);
ffffffffc0203148:	00002697          	auipc	a3,0x2
ffffffffc020314c:	3b068693          	addi	a3,a3,944 # ffffffffc02054f8 <default_pmm_manager+0x7e8>
ffffffffc0203150:	00002617          	auipc	a2,0x2
ffffffffc0203154:	81060613          	addi	a2,a2,-2032 # ffffffffc0204960 <commands+0x818>
ffffffffc0203158:	0f400593          	li	a1,244
ffffffffc020315c:	00002517          	auipc	a0,0x2
ffffffffc0203160:	2cc50513          	addi	a0,a0,716 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc0203164:	af6fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma1 != NULL);
ffffffffc0203168:	00002697          	auipc	a3,0x2
ffffffffc020316c:	38068693          	addi	a3,a3,896 # ffffffffc02054e8 <default_pmm_manager+0x7d8>
ffffffffc0203170:	00001617          	auipc	a2,0x1
ffffffffc0203174:	7f060613          	addi	a2,a2,2032 # ffffffffc0204960 <commands+0x818>
ffffffffc0203178:	0f200593          	li	a1,242
ffffffffc020317c:	00002517          	auipc	a0,0x2
ffffffffc0203180:	2ac50513          	addi	a0,a0,684 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc0203184:	ad6fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma3 == NULL);
ffffffffc0203188:	00002697          	auipc	a3,0x2
ffffffffc020318c:	38068693          	addi	a3,a3,896 # ffffffffc0205508 <default_pmm_manager+0x7f8>
ffffffffc0203190:	00001617          	auipc	a2,0x1
ffffffffc0203194:	7d060613          	addi	a2,a2,2000 # ffffffffc0204960 <commands+0x818>
ffffffffc0203198:	0f600593          	li	a1,246
ffffffffc020319c:	00002517          	auipc	a0,0x2
ffffffffc02031a0:	28c50513          	addi	a0,a0,652 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc02031a4:	ab6fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma5 == NULL);
ffffffffc02031a8:	00002697          	auipc	a3,0x2
ffffffffc02031ac:	38068693          	addi	a3,a3,896 # ffffffffc0205528 <default_pmm_manager+0x818>
ffffffffc02031b0:	00001617          	auipc	a2,0x1
ffffffffc02031b4:	7b060613          	addi	a2,a2,1968 # ffffffffc0204960 <commands+0x818>
ffffffffc02031b8:	0fa00593          	li	a1,250
ffffffffc02031bc:	00002517          	auipc	a0,0x2
ffffffffc02031c0:	26c50513          	addi	a0,a0,620 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc02031c4:	a96fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma4 == NULL);
ffffffffc02031c8:	00002697          	auipc	a3,0x2
ffffffffc02031cc:	35068693          	addi	a3,a3,848 # ffffffffc0205518 <default_pmm_manager+0x808>
ffffffffc02031d0:	00001617          	auipc	a2,0x1
ffffffffc02031d4:	79060613          	addi	a2,a2,1936 # ffffffffc0204960 <commands+0x818>
ffffffffc02031d8:	0f800593          	li	a1,248
ffffffffc02031dc:	00002517          	auipc	a0,0x2
ffffffffc02031e0:	24c50513          	addi	a0,a0,588 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc02031e4:	a76fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(mm != NULL);
ffffffffc02031e8:	00002697          	auipc	a3,0x2
ffffffffc02031ec:	43868693          	addi	a3,a3,1080 # ffffffffc0205620 <default_pmm_manager+0x910>
ffffffffc02031f0:	00001617          	auipc	a2,0x1
ffffffffc02031f4:	77060613          	addi	a2,a2,1904 # ffffffffc0204960 <commands+0x818>
ffffffffc02031f8:	0d200593          	li	a1,210
ffffffffc02031fc:	00002517          	auipc	a0,0x2
ffffffffc0203200:	22c50513          	addi	a0,a0,556 # ffffffffc0205428 <default_pmm_manager+0x718>
...
ffffffffc020320a:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc020320c:	424000ef          	jal	ra,ffffffffc0203630 <do_exit>
...
ffffffffc0203246:	447000ef          	jal	ra,ffffffffc0203e8c <memset>
...
ffffffffc0203264:	429000ef          	jal	ra,ffffffffc0203e8c <memset>
    }
    return proc;
}
...
ffffffffc02032ce:	38e50513          	addi	a0,a0,910 # ffffffffc0205658 <default_pmm_manager+0x948>
ffffffffc02032d2:	ec3fc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02032d6:	00002517          	auipc	a0,0x2
ffffffffc02032da:	39250513          	addi	a0,a0,914 # ffffffffc0205668 <default_pmm_manager+0x958>
...
ffffffffc02032f4:	ec4a                	sd	s2,24(sp)
    if (proc != current)
ffffffffc02032f6:	0000a917          	auipc	s2,0xa
ffffffffc02032fa:	1da90913          	addi	s2,s2,474 # ffffffffc020d4d0 <current>
{
ffffffffc02032fe:	f026                	sd	s1,32(sp)
    if (proc != current)
ffffffffc0203300:	00093483          	ld	s1,0(s2)
{
ffffffffc0203304:	f406                	sd	ra,40(sp)
ffffffffc0203306:	e84e                	sd	s3,16(sp)
    if (proc != current)
ffffffffc0203308:	02a48963          	beq	s1,a0,ffffffffc020333a <proc_run+0x48>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020330c:	100027f3          	csrr	a5,sstatus
ffffffffc0203310:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0203312:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0203314:	e3a1                	bnez	a5,ffffffffc0203354 <proc_run+0x62>
            lsatp(next->pgdir);                     // 切换页表，使用新进程的地址空间
ffffffffc0203316:	755c                	ld	a5,168(a0)
...
ffffffffc0203318:	80000737          	lui	a4,0x80000
            current = proc;                         // 切换当前进程为要运行的进程
ffffffffc020331c:	00a93023          	sd	a0,0(s2)
ffffffffc0203320:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc0203324:	8fd9                	or	a5,a5,a4
ffffffffc0203326:	18079073          	csrw	satp,a5
            switch_to(&(prev->context), &(next->context)); // 实现上下文切换
ffffffffc020332a:	03050593          	addi	a1,a0,48
ffffffffc020332e:	03048513          	addi	a0,s1,48
ffffffffc0203332:	584000ef          	jal	ra,ffffffffc02038b6 <switch_to>
    if (flag) {
ffffffffc0203336:	00099863          	bnez	s3,ffffffffc0203346 <proc_run+0x54>
}
ffffffffc020333a:	70a2                	ld	ra,40(sp)
ffffffffc020333c:	7482                	ld	s1,32(sp)
ffffffffc020333e:	6962                	ld	s2,24(sp)
ffffffffc0203340:	69c2                	ld	s3,16(sp)
...
ffffffffc020335e:	bf65                	j	ffffffffc0203316 <proc_run+0x24>
...
ffffffffc020337a:	22f75063          	bge	a4,a5,ffffffffc020359a <do_fork+0x23a>
ffffffffc020337e:	892e                	mv	s2,a1
ffffffffc0203380:	8432                	mv	s0,a2
    if ((proc = alloc_proc()) == NULL) {
ffffffffc0203382:	e8fff0ef          	jal	ra,ffffffffc0203210 <alloc_proc>
ffffffffc0203386:	89aa                	mv	s3,a0
ffffffffc0203388:	20050e63          	beqz	a0,ffffffffc02035a4 <do_fork+0x244>
    proc->parent = current;
ffffffffc020338c:	0000aa17          	auipc	s4,0xa
ffffffffc0203390:	144a0a13          	addi	s4,s4,324 # ffffffffc020d4d0 <current>
ffffffffc0203394:	000a3783          	ld	a5,0(s4)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0203398:	4509                	li	a0,2
    proc->parent = current;
ffffffffc020339a:	02f9b023          	sd	a5,32(s3)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc020339e:	8fbfe0ef          	jal	ra,ffffffffc0201c98 <alloc_pages>
    if (page != NULL)
ffffffffc02033a2:	1e050763          	beqz	a0,ffffffffc0203590 <do_fork+0x230>
    return page - pages + nbase;
ffffffffc02033a6:	0000a697          	auipc	a3,0xa
ffffffffc02033aa:	1126b683          	ld	a3,274(a3) # ffffffffc020d4b8 <pages>
ffffffffc02033ae:	40d506b3          	sub	a3,a0,a3
ffffffffc02033b2:	8699                	srai	a3,a3,0x6
ffffffffc02033b4:	00002517          	auipc	a0,0x2
ffffffffc02033b8:	67453503          	ld	a0,1652(a0) # ffffffffc0205a28 <nbase>
ffffffffc02033bc:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc02033be:	00c69793          	slli	a5,a3,0xc
ffffffffc02033c2:	83b1                	srli	a5,a5,0xc
ffffffffc02033c4:	0000a717          	auipc	a4,0xa
ffffffffc02033c8:	0ec73703          	ld	a4,236(a4) # ffffffffc020d4b0 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02033cc:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02033ce:	1ee7fd63          	bgeu	a5,a4,ffffffffc02035c8 <do_fork+0x268>
    assert(current->mm == NULL);
ffffffffc02033d2:	000a3783          	ld	a5,0(s4)
ffffffffc02033d6:	0000a717          	auipc	a4,0xa
ffffffffc02033da:	0f273703          	ld	a4,242(a4) # ffffffffc020d4c8 <va_pa_offset>
ffffffffc02033de:	96ba                	add	a3,a3,a4
ffffffffc02033e0:	779c                	ld	a5,40(a5)
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02033e2:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc02033e6:	1c079163          	bnez	a5,ffffffffc02035a8 <do_fork+0x248>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02033ea:	6789                	lui	a5,0x2
ffffffffc02033ec:	ee078793          	addi	a5,a5,-288 # 1ee0 <kern_entry-0xffffffffc01fe120>
ffffffffc02033f0:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc02033f2:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02033f4:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
ffffffffc02033f8:	87b6                	mv	a5,a3
ffffffffc02033fa:	12040893          	addi	a7,s0,288
ffffffffc02033fe:	00063803          	ld	a6,0(a2)
ffffffffc0203402:	6608                	ld	a0,8(a2)
ffffffffc0203404:	6a0c                	ld	a1,16(a2)
ffffffffc0203406:	6e18                	ld	a4,24(a2)
ffffffffc0203408:	0107b023          	sd	a6,0(a5)
ffffffffc020340c:	e788                	sd	a0,8(a5)
ffffffffc020340e:	eb8c                	sd	a1,16(a5)
ffffffffc0203410:	ef98                	sd	a4,24(a5)
ffffffffc0203412:	02060613          	addi	a2,a2,32
ffffffffc0203416:	02078793          	addi	a5,a5,32
ffffffffc020341a:	ff1612e3          	bne	a2,a7,ffffffffc02033fe <do_fork+0x9e>
    proc->tf->gpr.a0 = 0;
ffffffffc020341e:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0203422:	12090563          	beqz	s2,ffffffffc020354c <do_fork+0x1ec>
ffffffffc0203426:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020342a:	00000797          	auipc	a5,0x0
ffffffffc020342e:	e4878793          	addi	a5,a5,-440 # ffffffffc0203272 <forkret>
ffffffffc0203432:	02f9b823          	sd	a5,48(s3)
...
ffffffffc020343e:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0203440:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0203442:	12079663          	bnez	a5,ffffffffc020356e <do_fork+0x20e>
    if (++last_pid >= MAX_PID)
ffffffffc0203446:	00006817          	auipc	a6,0x6
ffffffffc020344a:	be280813          	addi	a6,a6,-1054 # ffffffffc0209028 <last_pid.1>
ffffffffc020344e:	00082783          	lw	a5,0(a6)
ffffffffc0203452:	6709                	lui	a4,0x2
ffffffffc0203454:	0017851b          	addiw	a0,a5,1
ffffffffc0203458:	00a82023          	sw	a0,0(a6)
ffffffffc020345c:	08e55163          	bge	a0,a4,ffffffffc02034de <do_fork+0x17e>
    if (last_pid >= next_safe)
ffffffffc0203460:	00006317          	auipc	t1,0x6
ffffffffc0203464:	bcc30313          	addi	t1,t1,-1076 # ffffffffc020902c <next_safe.0>
ffffffffc0203468:	00032783          	lw	a5,0(t1)
ffffffffc020346c:	0000a417          	auipc	s0,0xa
ffffffffc0203470:	fec40413          	addi	s0,s0,-20 # ffffffffc020d458 <proc_list>
ffffffffc0203474:	06f55d63          	bge	a0,a5,ffffffffc02034ee <do_fork+0x18e>
...
ffffffffc0203480:	566000ef          	jal	ra,ffffffffc02039e6 <hash32>
...
ffffffffc0203494:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0203496:	6510                	ld	a2,8(a0)
ffffffffc0203498:	0d898793          	addi	a5,s3,216
ffffffffc020349c:	6414                	ld	a3,8(s0)
        nr_process++;                       // 进程总数加1
ffffffffc020349e:	4098                	lw	a4,0(s1)
    prev->next = next->prev = elm;
ffffffffc02034a0:	e21c                	sd	a5,0(a2)
ffffffffc02034a2:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc02034a4:	0ec9b023          	sd	a2,224(s3)
        list_add(&proc_list, &(proc->list_link)); // 将进程加入进程链表
ffffffffc02034a8:	0c898793          	addi	a5,s3,200
    elm->prev = prev;
ffffffffc02034ac:	0ca9bc23          	sd	a0,216(s3)
    prev->next = next->prev = elm;
ffffffffc02034b0:	e29c                	sd	a5,0(a3)
        nr_process++;                       // 进程总数加1
ffffffffc02034b2:	2705                	addiw	a4,a4,1
ffffffffc02034b4:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc02034b6:	0cd9b823          	sd	a3,208(s3)
    elm->prev = prev;
ffffffffc02034ba:	0c89b423          	sd	s0,200(s3)
ffffffffc02034be:	c098                	sw	a4,0(s1)
    if (flag) {
ffffffffc02034c0:	0a091b63          	bnez	s2,ffffffffc0203576 <do_fork+0x216>
    wakeup_proc(proc);
ffffffffc02034c4:	854e                	mv	a0,s3
ffffffffc02034c6:	45a000ef          	jal	ra,ffffffffc0203920 <wakeup_proc>
    ret = proc->pid;
ffffffffc02034ca:	0049a503          	lw	a0,4(s3)
}
...
ffffffffc02034d8:	6a02                	ld	s4,0(sp)
ffffffffc02034da:	6145                	addi	sp,sp,48
ffffffffc02034dc:	8082                	ret
        last_pid = 1;
ffffffffc02034de:	4785                	li	a5,1
ffffffffc02034e0:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02034e4:	4505                	li	a0,1
ffffffffc02034e6:	00006317          	auipc	t1,0x6
ffffffffc02034ea:	b4630313          	addi	t1,t1,-1210 # ffffffffc020902c <next_safe.0>
    return listelm->next;
ffffffffc02034ee:	0000a417          	auipc	s0,0xa
ffffffffc02034f2:	f6a40413          	addi	s0,s0,-150 # ffffffffc020d458 <proc_list>
ffffffffc02034f6:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc02034fa:	6789                	lui	a5,0x2
ffffffffc02034fc:	00f32023          	sw	a5,0(t1)
ffffffffc0203500:	86aa                	mv	a3,a0
ffffffffc0203502:	4581                	li	a1,0
        while ((le = list_next(le)) != list)
ffffffffc0203504:	6e89                	lui	t4,0x2
ffffffffc0203506:	088e0063          	beq	t3,s0,ffffffffc0203586 <do_fork+0x226>
ffffffffc020350a:	88ae                	mv	a7,a1
ffffffffc020350c:	87f2                	mv	a5,t3
ffffffffc020350e:	6609                	lui	a2,0x2
ffffffffc0203510:	a811                	j	ffffffffc0203524 <do_fork+0x1c4>
            else if (proc->pid > last_pid && next_safe > proc->pid)
ffffffffc0203512:	00e6d663          	bge	a3,a4,ffffffffc020351e <do_fork+0x1be>
ffffffffc0203516:	00c75463          	bge	a4,a2,ffffffffc020351e <do_fork+0x1be>
ffffffffc020351a:	863a                	mv	a2,a4
ffffffffc020351c:	4885                	li	a7,1
ffffffffc020351e:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0203520:	00878d63          	beq	a5,s0,ffffffffc020353a <do_fork+0x1da>
            if (proc->pid == last_pid)
ffffffffc0203524:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0203528:	fed715e3          	bne	a4,a3,ffffffffc0203512 <do_fork+0x1b2>
                if (++last_pid >= next_safe)
ffffffffc020352c:	2685                	addiw	a3,a3,1
ffffffffc020352e:	04c6d763          	bge	a3,a2,ffffffffc020357c <do_fork+0x21c>
ffffffffc0203532:	679c                	ld	a5,8(a5)
ffffffffc0203534:	4585                	li	a1,1
        while ((le = list_next(le)) != list)
ffffffffc0203536:	fe8797e3          	bne	a5,s0,ffffffffc0203524 <do_fork+0x1c4>
ffffffffc020353a:	c581                	beqz	a1,ffffffffc0203542 <do_fork+0x1e2>
ffffffffc020353c:	00d82023          	sw	a3,0(a6)
ffffffffc0203540:	8536                	mv	a0,a3
ffffffffc0203542:	f2088be3          	beqz	a7,ffffffffc0203478 <do_fork+0x118>
ffffffffc0203546:	00c32023          	sw	a2,0(t1)
ffffffffc020354a:	b73d                	j	ffffffffc0203478 <do_fork+0x118>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020354c:	8936                	mv	s2,a3
ffffffffc020354e:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0203552:	00000797          	auipc	a5,0x0
ffffffffc0203556:	d2078793          	addi	a5,a5,-736 # ffffffffc0203272 <forkret>
ffffffffc020355a:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020355e:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0203562:	100027f3          	csrr	a5,sstatus
ffffffffc0203566:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0203568:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020356a:	ec078ee3          	beqz	a5,ffffffffc0203446 <do_fork+0xe6>
        intr_disable();
ffffffffc020356e:	bc2fd0ef          	jal	ra,ffffffffc0200930 <intr_disable>
        return 1;
ffffffffc0203572:	4905                	li	s2,1
ffffffffc0203574:	bdc9                	j	ffffffffc0203446 <do_fork+0xe6>
        intr_enable();
ffffffffc0203576:	bb4fd0ef          	jal	ra,ffffffffc020092a <intr_enable>
ffffffffc020357a:	b7a9                	j	ffffffffc02034c4 <do_fork+0x164>
                    if (last_pid >= MAX_PID)
ffffffffc020357c:	01d6c363          	blt	a3,t4,ffffffffc0203582 <do_fork+0x222>
                        last_pid = 1;
ffffffffc0203580:	4685                	li	a3,1
                    goto repeat;
ffffffffc0203582:	4585                	li	a1,1
ffffffffc0203584:	b749                	j	ffffffffc0203506 <do_fork+0x1a6>
ffffffffc0203586:	cd81                	beqz	a1,ffffffffc020359e <do_fork+0x23e>
ffffffffc0203588:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc020358c:	8536                	mv	a0,a3
ffffffffc020358e:	b5ed                	j	ffffffffc0203478 <do_fork+0x118>
    kfree(proc);
ffffffffc0203590:	854e                	mv	a0,s3
ffffffffc0203592:	dd8fe0ef          	jal	ra,ffffffffc0201b6a <kfree>
    ret = -E_NO_MEM;
ffffffffc0203596:	5571                	li	a0,-4
    goto fork_out;
ffffffffc0203598:	bf1d                	j	ffffffffc02034ce <do_fork+0x16e>
    int ret = -E_NO_FREE_PROC;
ffffffffc020359a:	556d                	li	a0,-5
ffffffffc020359c:	bf0d                	j	ffffffffc02034ce <do_fork+0x16e>
    return last_pid;
ffffffffc020359e:	00082503          	lw	a0,0(a6)
ffffffffc02035a2:	bdd9                	j	ffffffffc0203478 <do_fork+0x118>
    ret = -E_NO_MEM;
ffffffffc02035a4:	5571                	li	a0,-4
    return ret;
ffffffffc02035a6:	b725                	j	ffffffffc02034ce <do_fork+0x16e>
    assert(current->mm == NULL);
ffffffffc02035a8:	00002697          	auipc	a3,0x2
ffffffffc02035ac:	0e068693          	addi	a3,a3,224 # ffffffffc0205688 <default_pmm_manager+0x978>
ffffffffc02035b0:	00001617          	auipc	a2,0x1
ffffffffc02035b4:	3b060613          	addi	a2,a2,944 # ffffffffc0204960 <commands+0x818>
ffffffffc02035b8:	11d00593          	li	a1,285
ffffffffc02035bc:	00002517          	auipc	a0,0x2
ffffffffc02035c0:	0e450513          	addi	a0,a0,228 # ffffffffc02056a0 <default_pmm_manager+0x990>
ffffffffc02035c4:	e97fc0ef          	jal	ra,ffffffffc020045a <__panic>
ffffffffc02035c8:	00001617          	auipc	a2,0x1
ffffffffc02035cc:	78060613          	addi	a2,a2,1920 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc02035d0:	07100593          	li	a1,113
ffffffffc02035d4:	00001517          	auipc	a0,0x1
ffffffffc02035d8:	79c50513          	addi	a0,a0,1948 # ffffffffc0204d70 <default_pmm_manager+0x60>
ffffffffc02035dc:	e7ffc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc02035e0 <kernel_thread>:
{
ffffffffc02035e0:	7129                	addi	sp,sp,-320
ffffffffc02035e2:	fa22                	sd	s0,304(sp)
ffffffffc02035e4:	f626                	sd	s1,296(sp)
ffffffffc02035e6:	f24a                	sd	s2,288(sp)
ffffffffc02035e8:	84ae                	mv	s1,a1
ffffffffc02035ea:	892a                	mv	s2,a0
ffffffffc02035ec:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02035ee:	4581                	li	a1,0
ffffffffc02035f0:	12000613          	li	a2,288
ffffffffc02035f4:	850a                	mv	a0,sp
{
ffffffffc02035f6:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02035f8:	095000ef          	jal	ra,ffffffffc0203e8c <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02035fc:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02035fe:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc0203600:	100027f3          	csrr	a5,sstatus
ffffffffc0203604:	edd7f793          	andi	a5,a5,-291
ffffffffc0203608:	1207e793          	ori	a5,a5,288
ffffffffc020360c:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020360e:	860a                	mv	a2,sp
ffffffffc0203610:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0203614:	00000797          	auipc	a5,0x0
ffffffffc0203618:	bf478793          	addi	a5,a5,-1036 # ffffffffc0203208 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020361c:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc020361e:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0203620:	d41ff0ef          	jal	ra,ffffffffc0203360 <do_fork>
}
ffffffffc0203624:	70f2                	ld	ra,312(sp)
ffffffffc0203626:	7452                	ld	s0,304(sp)
ffffffffc0203628:	74b2                	ld	s1,296(sp)
ffffffffc020362a:	7912                	ld	s2,288(sp)
ffffffffc020362c:	6131                	addi	sp,sp,320
ffffffffc020362e:	8082                	ret

ffffffffc0203630 <do_exit>:
{
ffffffffc0203630:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc0203632:	00002617          	auipc	a2,0x2
ffffffffc0203636:	08660613          	addi	a2,a2,134 # ffffffffc02056b8 <default_pmm_manager+0x9a8>
ffffffffc020363a:	19000593          	li	a1,400
ffffffffc020363e:	00002517          	auipc	a0,0x2
ffffffffc0203642:	06250513          	addi	a0,a0,98 # ffffffffc02056a0 <default_pmm_manager+0x990>
{
ffffffffc0203646:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc0203648:	e13fc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc020364c <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and
//           - create the second kernel thread init_main
void proc_init(void)
{
ffffffffc020364c:	7179                	addi	sp,sp,-48
ffffffffc020364e:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc0203650:	0000a797          	auipc	a5,0xa
ffffffffc0203654:	e0878793          	addi	a5,a5,-504 # ffffffffc020d458 <proc_list>
ffffffffc0203658:	f406                	sd	ra,40(sp)
ffffffffc020365a:	f022                	sd	s0,32(sp)
ffffffffc020365c:	e84a                	sd	s2,16(sp)
ffffffffc020365e:	e44e                	sd	s3,8(sp)
ffffffffc0203660:	00006497          	auipc	s1,0x6
ffffffffc0203664:	de848493          	addi	s1,s1,-536 # ffffffffc0209448 <hash_list>
ffffffffc0203668:	e79c                	sd	a5,8(a5)
ffffffffc020366a:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i++)
ffffffffc020366c:	0000a717          	auipc	a4,0xa
ffffffffc0203670:	ddc70713          	addi	a4,a4,-548 # ffffffffc020d448 <name.2>
ffffffffc0203674:	87a6                	mv	a5,s1
ffffffffc0203676:	e79c                	sd	a5,8(a5)
ffffffffc0203678:	e39c                	sd	a5,0(a5)
ffffffffc020367a:	07c1                	addi	a5,a5,16
ffffffffc020367c:	fef71de3          	bne	a4,a5,ffffffffc0203676 <proc_init+0x2a>
    {
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL)
ffffffffc0203680:	b91ff0ef          	jal	ra,ffffffffc0203210 <alloc_proc>
ffffffffc0203684:	0000a917          	auipc	s2,0xa
ffffffffc0203688:	e5490913          	addi	s2,s2,-428 # ffffffffc020d4d8 <idleproc>
ffffffffc020368c:	00a93023          	sd	a0,0(s2)
ffffffffc0203690:	18050d63          	beqz	a0,ffffffffc020382a <proc_init+0x1de>
    {
...
ffffffffc0203694:	07000513          	li	a0,112
ffffffffc0203698:	c22fe0ef          	jal	ra,ffffffffc0201aba <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc020369c:	07000613          	li	a2,112
ffffffffc02036a0:	4581                	li	a1,0
    int *context_mem = (int *)kmalloc(sizeof(struct context));
ffffffffc02036a2:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02036a4:	7e8000ef          	jal	ra,ffffffffc0203e8c <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc02036a8:	00093503          	ld	a0,0(s2)
ffffffffc02036ac:	85a2                	mv	a1,s0
ffffffffc02036ae:	07000613          	li	a2,112
ffffffffc02036b2:	03050513          	addi	a0,a0,48
ffffffffc02036b6:	001000ef          	jal	ra,ffffffffc0203eb6 <memcmp>
ffffffffc02036ba:	89aa                	mv	s3,a0

    int *proc_name_mem = (int *)kmalloc(PROC_NAME_LEN);
ffffffffc02036bc:	453d                	li	a0,15
ffffffffc02036be:	bfcfe0ef          	jal	ra,ffffffffc0201aba <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02036c2:	463d                	li	a2,15
ffffffffc02036c4:	4581                	li	a1,0
    int *proc_name_mem = (int *)kmalloc(PROC_NAME_LEN);
ffffffffc02036c6:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02036c8:	7c4000ef          	jal	ra,ffffffffc0203e8c <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc02036cc:	00093503          	ld	a0,0(s2)
ffffffffc02036d0:	463d                	li	a2,15
ffffffffc02036d2:	85a2                	mv	a1,s0
ffffffffc02036d4:	0b450513          	addi	a0,a0,180
ffffffffc02036d8:	7de000ef          	jal	ra,ffffffffc0203eb6 <memcmp>
...
ffffffffc02036e0:	0000a717          	auipc	a4,0xa
ffffffffc02036e4:	dc073703          	ld	a4,-576(a4) # ffffffffc020d4a0 <boot_pgdir_pa>
ffffffffc02036e8:	77d4                	ld	a3,168(a5)
ffffffffc02036ea:	0ee68463          	beq	a3,a4,ffffffffc02037d2 <proc_init+0x186>
    {
...
ffffffffc02036ee:	4709                	li	a4,2
ffffffffc02036f0:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02036f2:	00003717          	auipc	a4,0x3
ffffffffc02036f6:	90e70713          	addi	a4,a4,-1778 # ffffffffc0206000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02036fa:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02036fe:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc0203700:	4705                	li	a4,1
ffffffffc0203702:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203704:	4641                	li	a2,16
ffffffffc0203706:	4581                	li	a1,0
ffffffffc0203708:	8522                	mv	a0,s0
ffffffffc020370a:	782000ef          	jal	ra,ffffffffc0203e8c <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020370e:	463d                	li	a2,15
ffffffffc0203710:	00002597          	auipc	a1,0x2
ffffffffc0203714:	ff058593          	addi	a1,a1,-16 # ffffffffc0205700 <default_pmm_manager+0x9f0>
ffffffffc0203718:	8522                	mv	a0,s0
ffffffffc020371a:	784000ef          	jal	ra,ffffffffc0203e9e <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process++;
ffffffffc020371e:	0000a717          	auipc	a4,0xa
ffffffffc0203722:	dca70713          	addi	a4,a4,-566 # ffffffffc020d4e8 <nr_process>
ffffffffc0203726:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0203728:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc020372c:	4601                	li	a2,0
    nr_process++;
ffffffffc020372e:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0203730:	00002597          	auipc	a1,0x2
ffffffffc0203734:	fd858593          	addi	a1,a1,-40 # ffffffffc0205708 <default_pmm_manager+0x9f8>
ffffffffc0203738:	00000517          	auipc	a0,0x0
ffffffffc020373c:	b4850513          	addi	a0,a0,-1208 # ffffffffc0203280 <init_main>
    nr_process++;
ffffffffc0203740:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0203742:	0000a797          	auipc	a5,0xa
ffffffffc0203746:	d8d7b723          	sd	a3,-626(a5) # ffffffffc020d4d0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc020374a:	e97ff0ef          	jal	ra,ffffffffc02035e0 <kernel_thread>
ffffffffc020374e:	842a                	mv	s0,a0
    if (pid <= 0)
ffffffffc0203750:	0ea05963          	blez	a0,ffffffffc0203842 <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID)
ffffffffc0203754:	6789                	lui	a5,0x2
ffffffffc0203756:	fff5071b          	addiw	a4,a0,-1
ffffffffc020375a:	17f9                	addi	a5,a5,-2
ffffffffc020375c:	2501                	sext.w	a0,a0
ffffffffc020375e:	02e7e363          	bltu	a5,a4,ffffffffc0203784 <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0203762:	45a9                	li	a1,10
ffffffffc0203764:	282000ef          	jal	ra,ffffffffc02039e6 <hash32>
ffffffffc0203768:	02051793          	slli	a5,a0,0x20
ffffffffc020376c:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0203770:	96a6                	add	a3,a3,s1
ffffffffc0203772:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list)
ffffffffc0203774:	a029                	j	ffffffffc020377e <proc_init+0x132>
            if (proc->pid == pid)
ffffffffc0203776:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc020377a:	0a870563          	beq	a4,s0,ffffffffc0203824 <proc_init+0x1d8>
    return listelm->next;
ffffffffc020377e:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0203780:	fef69be3          	bne	a3,a5,ffffffffc0203776 <proc_init+0x12a>
    return NULL;
ffffffffc0203784:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203786:	0b478493          	addi	s1,a5,180
ffffffffc020378a:	4641                	li	a2,16
ffffffffc020378c:	4581                	li	a1,0
    {
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc020378e:	0000a417          	auipc	s0,0xa
ffffffffc0203792:	d5240413          	addi	s0,s0,-686 # ffffffffc020d4e0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203796:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0203798:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020379a:	6f2000ef          	jal	ra,ffffffffc0203e8c <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020379e:	463d                	li	a2,15
ffffffffc02037a0:	00002597          	auipc	a1,0x2
ffffffffc02037a4:	f9858593          	addi	a1,a1,-104 # ffffffffc0205738 <default_pmm_manager+0xa28>
ffffffffc02037a8:	8526                	mv	a0,s1
ffffffffc02037aa:	6f4000ef          	jal	ra,ffffffffc0203e9e <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02037ae:	00093783          	ld	a5,0(s2)
ffffffffc02037b2:	c7e1                	beqz	a5,ffffffffc020387a <proc_init+0x22e>
ffffffffc02037b4:	43dc                	lw	a5,4(a5)
ffffffffc02037b6:	e3f1                	bnez	a5,ffffffffc020387a <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02037b8:	601c                	ld	a5,0(s0)
ffffffffc02037ba:	c3c5                	beqz	a5,ffffffffc020385a <proc_init+0x20e>
ffffffffc02037bc:	43d8                	lw	a4,4(a5)
ffffffffc02037be:	4785                	li	a5,1
ffffffffc02037c0:	08f71d63          	bne	a4,a5,ffffffffc020385a <proc_init+0x20e>
}
ffffffffc02037c4:	70a2                	ld	ra,40(sp)
ffffffffc02037c6:	7402                	ld	s0,32(sp)
ffffffffc02037c8:	64e2                	ld	s1,24(sp)
ffffffffc02037ca:	6942                	ld	s2,16(sp)
ffffffffc02037cc:	69a2                	ld	s3,8(sp)
ffffffffc02037ce:	6145                	addi	sp,sp,48
ffffffffc02037d0:	8082                	ret
    if (idleproc->pgdir == boot_pgdir_pa && idleproc->tf == NULL && !context_init_flag && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0 && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag)
ffffffffc02037d2:	73d8                	ld	a4,160(a5)
ffffffffc02037d4:	ff09                	bnez	a4,ffffffffc02036ee <proc_init+0xa2>
ffffffffc02037d6:	f0099ce3          	bnez	s3,ffffffffc02036ee <proc_init+0xa2>
ffffffffc02037da:	6394                	ld	a3,0(a5)
ffffffffc02037dc:	577d                	li	a4,-1
ffffffffc02037de:	1702                	slli	a4,a4,0x20
ffffffffc02037e0:	f0e697e3          	bne	a3,a4,ffffffffc02036ee <proc_init+0xa2>
ffffffffc02037e4:	4798                	lw	a4,8(a5)
ffffffffc02037e6:	f00714e3          	bnez	a4,ffffffffc02036ee <proc_init+0xa2>
ffffffffc02037ea:	6b98                	ld	a4,16(a5)
ffffffffc02037ec:	f00711e3          	bnez	a4,ffffffffc02036ee <proc_init+0xa2>
ffffffffc02037f0:	4f98                	lw	a4,24(a5)
ffffffffc02037f2:	2701                	sext.w	a4,a4
ffffffffc02037f4:	ee071de3          	bnez	a4,ffffffffc02036ee <proc_init+0xa2>
ffffffffc02037f8:	7398                	ld	a4,32(a5)
ffffffffc02037fa:	ee071ae3          	bnez	a4,ffffffffc02036ee <proc_init+0xa2>
ffffffffc02037fe:	7798                	ld	a4,40(a5)
ffffffffc0203800:	ee0717e3          	bnez	a4,ffffffffc02036ee <proc_init+0xa2>
ffffffffc0203804:	0b07a703          	lw	a4,176(a5)
ffffffffc0203808:	8d59                	or	a0,a0,a4
ffffffffc020380a:	0005071b          	sext.w	a4,a0
ffffffffc020380e:	ee0710e3          	bnez	a4,ffffffffc02036ee <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc0203812:	00002517          	auipc	a0,0x2
ffffffffc0203816:	ed650513          	addi	a0,a0,-298 # ffffffffc02056e8 <default_pmm_manager+0x9d8>
ffffffffc020381a:	97bfc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    idleproc->pid = 0;
ffffffffc020381e:	00093783          	ld	a5,0(s2)
ffffffffc0203822:	b5f1                	j	ffffffffc02036ee <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0203824:	f2878793          	addi	a5,a5,-216
ffffffffc0203828:	bfb9                	j	ffffffffc0203786 <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc020382a:	00002617          	auipc	a2,0x2
ffffffffc020382e:	ea660613          	addi	a2,a2,-346 # ffffffffc02056d0 <default_pmm_manager+0x9c0>
ffffffffc0203832:	1ab00593          	li	a1,427
ffffffffc0203836:	00002517          	auipc	a0,0x2
ffffffffc020383a:	e6a50513          	addi	a0,a0,-406 # ffffffffc02056a0 <default_pmm_manager+0x990>
ffffffffc020383e:	c1dfc0ef          	jal	ra,ffffffffc020045a <__panic>
        panic("create init_main failed.\n");
ffffffffc0203842:	00002617          	auipc	a2,0x2
ffffffffc0203846:	ed660613          	addi	a2,a2,-298 # ffffffffc0205718 <default_pmm_manager+0xa08>
ffffffffc020384a:	1c800593          	li	a1,456
ffffffffc020384e:	00002517          	auipc	a0,0x2
ffffffffc0203852:	e5250513          	addi	a0,a0,-430 # ffffffffc02056a0 <default_pmm_manager+0x990>
ffffffffc0203856:	c05fc0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020385a:	00002697          	auipc	a3,0x2
ffffffffc020385e:	f0e68693          	addi	a3,a3,-242 # ffffffffc0205768 <default_pmm_manager+0xa58>
ffffffffc0203862:	00001617          	auipc	a2,0x1
ffffffffc0203866:	0fe60613          	addi	a2,a2,254 # ffffffffc0204960 <commands+0x818>
ffffffffc020386a:	1cf00593          	li	a1,463
ffffffffc020386e:	00002517          	auipc	a0,0x2
ffffffffc0203872:	e3250513          	addi	a0,a0,-462 # ffffffffc02056a0 <default_pmm_manager+0x990>
ffffffffc0203876:	be5fc0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020387a:	00002697          	auipc	a3,0x2
ffffffffc020387e:	ec668693          	addi	a3,a3,-314 # ffffffffc0205740 <default_pmm_manager+0xa30>
ffffffffc0203882:	00001617          	auipc	a2,0x1
ffffffffc0203886:	0de60613          	addi	a2,a2,222 # ffffffffc0204960 <commands+0x818>
ffffffffc020388a:	1ce00593          	li	a1,462
ffffffffc020388e:	00002517          	auipc	a0,0x2
ffffffffc0203892:	e1250513          	addi	a0,a0,-494 # ffffffffc02056a0 <default_pmm_manager+0x990>
ffffffffc0203896:	bc5fc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc020389a <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void cpu_idle(void)
{
ffffffffc020389a:	1141                	addi	sp,sp,-16
ffffffffc020389c:	e022                	sd	s0,0(sp)
ffffffffc020389e:	e406                	sd	ra,8(sp)
ffffffffc02038a0:	0000a417          	auipc	s0,0xa
ffffffffc02038a4:	c3040413          	addi	s0,s0,-976 # ffffffffc020d4d0 <current>
    while (1)
    {
        if (current->need_resched)
ffffffffc02038a8:	6018                	ld	a4,0(s0)
ffffffffc02038aa:	4f1c                	lw	a5,24(a4)
ffffffffc02038ac:	2781                	sext.w	a5,a5
ffffffffc02038ae:	dff5                	beqz	a5,ffffffffc02038aa <cpu_idle+0x10>
        {
            schedule();
ffffffffc02038b0:	0a2000ef          	jal	ra,ffffffffc0203952 <schedule>
ffffffffc02038b4:	bfd5                	j	ffffffffc02038a8 <cpu_idle+0xe>

ffffffffc02038b6 <switch_to>:
.text
...
ffffffffc02038b6:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc02038ba:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc02038be:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc02038c0:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc02038c2:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc02038c6:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc02038ca:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc02038ce:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc02038d2:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc02038d6:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc02038da:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc02038de:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc02038e2:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc02038e6:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc02038ea:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc02038ee:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc02038f2:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc02038f4:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc02038f6:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc02038fa:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc02038fe:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0203902:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0203906:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc020390a:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc020390e:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0203912:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0203916:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc020391a:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc020391e:	8082                	ret

ffffffffc0203920 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0203920:	411c                	lw	a5,0(a0)
ffffffffc0203922:	4705                	li	a4,1
ffffffffc0203924:	37f9                	addiw	a5,a5,-2
ffffffffc0203926:	00f77563          	bgeu	a4,a5,ffffffffc0203930 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc020392a:	4789                	li	a5,2
ffffffffc020392c:	c11c                	sw	a5,0(a0)
ffffffffc020392e:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc0203930:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0203932:	00002697          	auipc	a3,0x2
ffffffffc0203936:	e5e68693          	addi	a3,a3,-418 # ffffffffc0205790 <default_pmm_manager+0xa80>
ffffffffc020393a:	00001617          	auipc	a2,0x1
ffffffffc020393e:	02660613          	addi	a2,a2,38 # ffffffffc0204960 <commands+0x818>
ffffffffc0203942:	45a5                	li	a1,9
ffffffffc0203944:	00002517          	auipc	a0,0x2
ffffffffc0203948:	e8c50513          	addi	a0,a0,-372 # ffffffffc02057d0 <default_pmm_manager+0xac0>
wakeup_proc(struct proc_struct *proc) {
ffffffffc020394c:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc020394e:	b0dfc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc0203952 <schedule>:
}
...
ffffffffc0203956:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0203958:	100027f3          	csrr	a5,sstatus
ffffffffc020395c:	8b89                	andi	a5,a5,2
ffffffffc020395e:	4401                	li	s0,0
ffffffffc0203960:	efbd                	bnez	a5,ffffffffc02039de <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0203962:	0000a897          	auipc	a7,0xa
ffffffffc0203966:	b6e8b883          	ld	a7,-1170(a7) # ffffffffc020d4d0 <current>
ffffffffc020396a:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020396e:	0000a517          	auipc	a0,0xa
ffffffffc0203972:	b6a53503          	ld	a0,-1174(a0) # ffffffffc020d4d8 <idleproc>
ffffffffc0203976:	04a88e63          	beq	a7,a0,ffffffffc02039d2 <schedule+0x80>
ffffffffc020397a:	0c888693          	addi	a3,a7,200
ffffffffc020397e:	0000a617          	auipc	a2,0xa
ffffffffc0203982:	ada60613          	addi	a2,a2,-1318 # ffffffffc020d458 <proc_list>
        le = last;
ffffffffc0203986:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
ffffffffc0203988:	4581                	li	a1,0
        do {
            if ((le = list_next(le)) != &proc_list) {
                next = le2proc(le, list_link);
                if (next->state == PROC_RUNNABLE) {
ffffffffc020398a:	4809                	li	a6,2
ffffffffc020398c:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc020398e:	00c78863          	beq	a5,a2,ffffffffc020399e <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0203992:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0203996:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc020399a:	03070163          	beq	a4,a6,ffffffffc02039bc <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc020399e:	fef697e3          	bne	a3,a5,ffffffffc020398c <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02039a2:	ed89                	bnez	a1,ffffffffc02039bc <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc02039a4:	451c                	lw	a5,8(a0)
ffffffffc02039a6:	2785                	addiw	a5,a5,1
ffffffffc02039a8:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc02039aa:	00a88463          	beq	a7,a0,ffffffffc02039b2 <schedule+0x60>
            proc_run(next);
ffffffffc02039ae:	945ff0ef          	jal	ra,ffffffffc02032f2 <proc_run>
    if (flag) {
ffffffffc02039b2:	e819                	bnez	s0,ffffffffc02039c8 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc02039b4:	60a2                	ld	ra,8(sp)
ffffffffc02039b6:	6402                	ld	s0,0(sp)
ffffffffc02039b8:	0141                	addi	sp,sp,16
ffffffffc02039ba:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02039bc:	4198                	lw	a4,0(a1)
ffffffffc02039be:	4789                	li	a5,2
ffffffffc02039c0:	fef712e3          	bne	a4,a5,ffffffffc02039a4 <schedule+0x52>
ffffffffc02039c4:	852e                	mv	a0,a1
ffffffffc02039c6:	bff9                	j	ffffffffc02039a4 <schedule+0x52>
}
ffffffffc02039c8:	6402                	ld	s0,0(sp)
ffffffffc02039ca:	60a2                	ld	ra,8(sp)
ffffffffc02039cc:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc02039ce:	f5dfc06f          	j	ffffffffc020092a <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02039d2:	0000a617          	auipc	a2,0xa
ffffffffc02039d6:	a8660613          	addi	a2,a2,-1402 # ffffffffc020d458 <proc_list>
ffffffffc02039da:	86b2                	mv	a3,a2
ffffffffc02039dc:	b76d                	j	ffffffffc0203986 <schedule+0x34>
        intr_disable();
ffffffffc02039de:	f53fc0ef          	jal	ra,ffffffffc0200930 <intr_disable>
        return 1;
ffffffffc02039e2:	4405                	li	s0,1
ffffffffc02039e4:	bfbd                	j	ffffffffc0203962 <schedule+0x10>

ffffffffc02039e6 <hash32>:
 *
...
ffffffffc02039e6:	9e3707b7          	lui	a5,0x9e370
ffffffffc02039ea:	2785                	addiw	a5,a5,1
ffffffffc02039ec:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc02039f0:	02000793          	li	a5,32
ffffffffc02039f4:	9f8d                	subw	a5,a5,a1
}
ffffffffc02039f6:	00f5553b          	srlw	a0,a0,a5
ffffffffc02039fa:	8082                	ret

ffffffffc02039fc <printnum>:
 * */
static void
...
ffffffffc02039fc:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203a00:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203a02:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203a06:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203a08:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203a0c:	f022                	sd	s0,32(sp)
ffffffffc0203a0e:	ec26                	sd	s1,24(sp)
ffffffffc0203a10:	e84a                	sd	s2,16(sp)
ffffffffc0203a12:	f406                	sd	ra,40(sp)
ffffffffc0203a14:	e44e                	sd	s3,8(sp)
ffffffffc0203a16:	84aa                	mv	s1,a0
ffffffffc0203a18:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203a1a:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203a1e:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203a20:	03067e63          	bgeu	a2,a6,ffffffffc0203a5c <printnum+0x60>
ffffffffc0203a24:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203a26:	00805763          	blez	s0,ffffffffc0203a34 <printnum+0x38>
ffffffffc0203a2a:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203a2c:	85ca                	mv	a1,s2
ffffffffc0203a2e:	854e                	mv	a0,s3
ffffffffc0203a30:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203a32:	fc65                	bnez	s0,ffffffffc0203a2a <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203a34:	1a02                	slli	s4,s4,0x20
ffffffffc0203a36:	00002797          	auipc	a5,0x2
ffffffffc0203a3a:	db278793          	addi	a5,a5,-590 # ffffffffc02057e8 <default_pmm_manager+0xad8>
ffffffffc0203a3e:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203a42:	9a3e                	add	s4,s4,a5
}
ffffffffc0203a44:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203a46:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203a4a:	70a2                	ld	ra,40(sp)
ffffffffc0203a4c:	69a2                	ld	s3,8(sp)
ffffffffc0203a4e:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203a50:	85ca                	mv	a1,s2
ffffffffc0203a52:	87a6                	mv	a5,s1
}
ffffffffc0203a54:	6942                	ld	s2,16(sp)
ffffffffc0203a56:	64e2                	ld	s1,24(sp)
ffffffffc0203a58:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203a5a:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203a5c:	03065633          	divu	a2,a2,a6
ffffffffc0203a60:	8722                	mv	a4,s0
ffffffffc0203a62:	f9bff0ef          	jal	ra,ffffffffc02039fc <printnum>
ffffffffc0203a66:	b7f9                	j	ffffffffc0203a34 <printnum+0x38>

ffffffffc0203a68 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203a68:	7119                	addi	sp,sp,-128
...
ffffffffc0203a78:	f06a                	sd	s10,32(sp)
ffffffffc0203a7a:	fc86                	sd	ra,120(sp)
ffffffffc0203a7c:	f8a2                	sd	s0,112(sp)
ffffffffc0203a7e:	f862                	sd	s8,48(sp)
ffffffffc0203a80:	f466                	sd	s9,40(sp)
ffffffffc0203a82:	ec6e                	sd	s11,24(sp)
ffffffffc0203a84:	892a                	mv	s2,a0
ffffffffc0203a86:	84ae                	mv	s1,a1
ffffffffc0203a88:	8d32                	mv	s10,a2
ffffffffc0203a8a:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203a8c:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203a90:	5b7d                	li	s6,-1
ffffffffc0203a92:	00002a97          	auipc	s5,0x2
ffffffffc0203a96:	d82a8a93          	addi	s5,s5,-638 # ffffffffc0205814 <default_pmm_manager+0xb04>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203a9a:	00002b97          	auipc	s7,0x2
ffffffffc0203a9e:	f56b8b93          	addi	s7,s7,-170 # ffffffffc02059f0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203aa2:	000d4503          	lbu	a0,0(s10)
ffffffffc0203aa6:	001d0413          	addi	s0,s10,1
ffffffffc0203aaa:	01350a63          	beq	a0,s3,ffffffffc0203abe <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203aae:	c121                	beqz	a0,ffffffffc0203aee <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203ab0:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203ab2:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203ab4:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203ab6:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203aba:	ff351ae3          	bne	a0,s3,ffffffffc0203aae <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203abe:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203ac2:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203ac6:	4c81                	li	s9,0
ffffffffc0203ac8:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203aca:	5c7d                	li	s8,-1
ffffffffc0203acc:	5dfd                	li	s11,-1
ffffffffc0203ace:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203ad2:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ad4:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203ad8:	0ff5f593          	zext.b	a1,a1
ffffffffc0203adc:	00140d13          	addi	s10,s0,1
ffffffffc0203ae0:	04b56263          	bltu	a0,a1,ffffffffc0203b24 <vprintfmt+0xbc>
ffffffffc0203ae4:	058a                	slli	a1,a1,0x2
ffffffffc0203ae6:	95d6                	add	a1,a1,s5
ffffffffc0203ae8:	4194                	lw	a3,0(a1)
ffffffffc0203aea:	96d6                	add	a3,a3,s5
ffffffffc0203aec:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203aee:	70e6                	ld	ra,120(sp)
ffffffffc0203af0:	7446                	ld	s0,112(sp)
ffffffffc0203af2:	74a6                	ld	s1,104(sp)
ffffffffc0203af4:	7906                	ld	s2,96(sp)
ffffffffc0203af6:	69e6                	ld	s3,88(sp)
ffffffffc0203af8:	6a46                	ld	s4,80(sp)
ffffffffc0203afa:	6aa6                	ld	s5,72(sp)
ffffffffc0203afc:	6b06                	ld	s6,64(sp)
ffffffffc0203afe:	7be2                	ld	s7,56(sp)
ffffffffc0203b00:	7c42                	ld	s8,48(sp)
ffffffffc0203b02:	7ca2                	ld	s9,40(sp)
ffffffffc0203b04:	7d02                	ld	s10,32(sp)
ffffffffc0203b06:	6de2                	ld	s11,24(sp)
ffffffffc0203b08:	6109                	addi	sp,sp,128
ffffffffc0203b0a:	8082                	ret
            padc = '0';
ffffffffc0203b0c:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203b0e:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b12:	846a                	mv	s0,s10
ffffffffc0203b14:	00140d13          	addi	s10,s0,1
ffffffffc0203b18:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203b1c:	0ff5f593          	zext.b	a1,a1
ffffffffc0203b20:	fcb572e3          	bgeu	a0,a1,ffffffffc0203ae4 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203b24:	85a6                	mv	a1,s1
ffffffffc0203b26:	02500513          	li	a0,37
ffffffffc0203b2a:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203b2c:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203b30:	8d22                	mv	s10,s0
ffffffffc0203b32:	f73788e3          	beq	a5,s3,ffffffffc0203aa2 <vprintfmt+0x3a>
ffffffffc0203b36:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203b3a:	1d7d                	addi	s10,s10,-1
ffffffffc0203b3c:	ff379de3          	bne	a5,s3,ffffffffc0203b36 <vprintfmt+0xce>
ffffffffc0203b40:	b78d                	j	ffffffffc0203aa2 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203b42:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0203b46:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b4a:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0203b4c:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203b50:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203b54:	02d86463          	bltu	a6,a3,ffffffffc0203b7c <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203b58:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203b5c:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203b60:	0186873b          	addw	a4,a3,s8
ffffffffc0203b64:	0017171b          	slliw	a4,a4,0x1
ffffffffc0203b68:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0203b6a:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0203b6e:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0203b70:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0203b74:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203b78:	fed870e3          	bgeu	a6,a3,ffffffffc0203b58 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0203b7c:	f40ddce3          	bgez	s11,ffffffffc0203ad4 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0203b80:	8de2                	mv	s11,s8
ffffffffc0203b82:	5c7d                	li	s8,-1
ffffffffc0203b84:	bf81                	j	ffffffffc0203ad4 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0203b86:	fffdc693          	not	a3,s11
ffffffffc0203b8a:	96fd                	srai	a3,a3,0x3f
ffffffffc0203b8c:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b90:	00144603          	lbu	a2,1(s0)
ffffffffc0203b94:	2d81                	sext.w	s11,s11
ffffffffc0203b96:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203b98:	bf35                	j	ffffffffc0203ad4 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0203b9a:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b9e:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0203ba2:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ba4:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0203ba6:	bfd9                	j	ffffffffc0203b7c <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0203ba8:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203baa:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203bae:	01174463          	blt	a4,a7,ffffffffc0203bb6 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0203bb2:	1a088e63          	beqz	a7,ffffffffc0203d6e <vprintfmt+0x306>
...
ffffffffc0203bc0:	876e                	mv	a4,s11
ffffffffc0203bc2:	85a6                	mv	a1,s1
ffffffffc0203bc4:	854a                	mv	a0,s2
ffffffffc0203bc6:	e37ff0ef          	jal	ra,ffffffffc02039fc <printnum>
            break;
ffffffffc0203bca:	bde1                	j	ffffffffc0203aa2 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0203bcc:	000a2503          	lw	a0,0(s4)
ffffffffc0203bd0:	85a6                	mv	a1,s1
ffffffffc0203bd2:	0a21                	addi	s4,s4,8
ffffffffc0203bd4:	9902                	jalr	s2
            break;
ffffffffc0203bd6:	b5f1                	j	ffffffffc0203aa2 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203bd8:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203bda:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203bde:	01174463          	blt	a4,a7,ffffffffc0203be6 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0203be2:	18088163          	beqz	a7,ffffffffc0203d64 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0203be6:	000a3603          	ld	a2,0(s4)
ffffffffc0203bea:	46a9                	li	a3,10
ffffffffc0203bec:	8a2e                	mv	s4,a1
ffffffffc0203bee:	bfc1                	j	ffffffffc0203bbe <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bf0:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0203bf4:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bf6:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203bf8:	bdf1                	j	ffffffffc0203ad4 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0203bfa:	85a6                	mv	a1,s1
ffffffffc0203bfc:	02500513          	li	a0,37
ffffffffc0203c00:	9902                	jalr	s2
            break;
ffffffffc0203c02:	b545                	j	ffffffffc0203aa2 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203c04:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0203c08:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203c0a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203c0c:	b5e1                	j	ffffffffc0203ad4 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0203c0e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203c10:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203c14:	01174463          	blt	a4,a7,ffffffffc0203c1c <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0203c18:	14088163          	beqz	a7,ffffffffc0203d5a <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0203c1c:	000a3603          	ld	a2,0(s4)
ffffffffc0203c20:	46a1                	li	a3,8
ffffffffc0203c22:	8a2e                	mv	s4,a1
ffffffffc0203c24:	bf69                	j	ffffffffc0203bbe <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0203c26:	03000513          	li	a0,48
...
ffffffffc0203c32:	07800513          	li	a0,120
ffffffffc0203c36:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203c38:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0203c3a:	6782                	ld	a5,0(sp)
ffffffffc0203c3c:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203c3e:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0203c42:	bfb5                	j	ffffffffc0203bbe <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203c44:	000a3403          	ld	s0,0(s4)
ffffffffc0203c48:	008a0713          	addi	a4,s4,8
ffffffffc0203c4c:	e03a                	sd	a4,0(sp)
ffffffffc0203c4e:	14040263          	beqz	s0,ffffffffc0203d92 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0203c52:	0fb05763          	blez	s11,ffffffffc0203d40 <vprintfmt+0x2d8>
ffffffffc0203c56:	02d00693          	li	a3,45
ffffffffc0203c5a:	0cd79163          	bne	a5,a3,ffffffffc0203d1c <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c5e:	00044783          	lbu	a5,0(s0)
ffffffffc0203c62:	0007851b          	sext.w	a0,a5
ffffffffc0203c66:	cf85                	beqz	a5,ffffffffc0203c9e <vprintfmt+0x236>
ffffffffc0203c68:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203c6c:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c70:	000c4563          	bltz	s8,ffffffffc0203c7a <vprintfmt+0x212>
ffffffffc0203c74:	3c7d                	addiw	s8,s8,-1
ffffffffc0203c76:	036c0263          	beq	s8,s6,ffffffffc0203c9a <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0203c7a:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203c7c:	0e0c8e63          	beqz	s9,ffffffffc0203d78 <vprintfmt+0x310>
ffffffffc0203c80:	3781                	addiw	a5,a5,-32
ffffffffc0203c82:	0ef47b63          	bgeu	s0,a5,ffffffffc0203d78 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0203c86:	03f00513          	li	a0,63
ffffffffc0203c8a:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c8c:	000a4783          	lbu	a5,0(s4)
ffffffffc0203c90:	3dfd                	addiw	s11,s11,-1
ffffffffc0203c92:	0a05                	addi	s4,s4,1
ffffffffc0203c94:	0007851b          	sext.w	a0,a5
ffffffffc0203c98:	ffe1                	bnez	a5,ffffffffc0203c70 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0203c9a:	01b05963          	blez	s11,ffffffffc0203cac <vprintfmt+0x244>
ffffffffc0203c9e:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0203ca0:	85a6                	mv	a1,s1
ffffffffc0203ca2:	02000513          	li	a0,32
ffffffffc0203ca6:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0203ca8:	fe0d9be3          	bnez	s11,ffffffffc0203c9e <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203cac:	6a02                	ld	s4,0(sp)
ffffffffc0203cae:	bbd5                	j	ffffffffc0203aa2 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203cb0:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203cb2:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0203cb6:	01174463          	blt	a4,a7,ffffffffc0203cbe <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0203cba:	08088d63          	beqz	a7,ffffffffc0203d54 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0203cbe:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0203cc2:	0a044d63          	bltz	s0,ffffffffc0203d7c <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0203cc6:	8622                	mv	a2,s0
ffffffffc0203cc8:	8a66                	mv	s4,s9
ffffffffc0203cca:	46a9                	li	a3,10
ffffffffc0203ccc:	bdcd                	j	ffffffffc0203bbe <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0203cce:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203cd2:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0203cd4:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0203cd6:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0203cda:	8fb5                	xor	a5,a5,a3
ffffffffc0203cdc:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203ce0:	02d74163          	blt	a4,a3,ffffffffc0203d02 <vprintfmt+0x29a>
ffffffffc0203ce4:	00369793          	slli	a5,a3,0x3
ffffffffc0203ce8:	97de                	add	a5,a5,s7
ffffffffc0203cea:	639c                	ld	a5,0(a5)
ffffffffc0203cec:	cb99                	beqz	a5,ffffffffc0203d02 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0203cee:	86be                	mv	a3,a5
ffffffffc0203cf0:	00000617          	auipc	a2,0x0
ffffffffc0203cf4:	21860613          	addi	a2,a2,536 # ffffffffc0203f08 <etext+0x2e>
ffffffffc0203cf8:	85a6                	mv	a1,s1
ffffffffc0203cfa:	854a                	mv	a0,s2
ffffffffc0203cfc:	0ce000ef          	jal	ra,ffffffffc0203dca <printfmt>
ffffffffc0203d00:	b34d                	j	ffffffffc0203aa2 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0203d02:	00002617          	auipc	a2,0x2
ffffffffc0203d06:	b0660613          	addi	a2,a2,-1274 # ffffffffc0205808 <default_pmm_manager+0xaf8>
ffffffffc0203d0a:	85a6                	mv	a1,s1
ffffffffc0203d0c:	854a                	mv	a0,s2
ffffffffc0203d0e:	0bc000ef          	jal	ra,ffffffffc0203dca <printfmt>
ffffffffc0203d12:	bb41                	j	ffffffffc0203aa2 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0203d14:	00002417          	auipc	s0,0x2
ffffffffc0203d18:	aec40413          	addi	s0,s0,-1300 # ffffffffc0205800 <default_pmm_manager+0xaf0>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203d1c:	85e2                	mv	a1,s8
ffffffffc0203d1e:	8522                	mv	a0,s0
ffffffffc0203d20:	e43e                	sd	a5,8(sp)
ffffffffc0203d22:	0e2000ef          	jal	ra,ffffffffc0203e04 <strnlen>
ffffffffc0203d26:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0203d2a:	01b05b63          	blez	s11,ffffffffc0203d40 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0203d2e:	67a2                	ld	a5,8(sp)
ffffffffc0203d30:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203d34:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0203d36:	85a6                	mv	a1,s1
ffffffffc0203d38:	8552                	mv	a0,s4
ffffffffc0203d3a:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203d3c:	fe0d9ce3          	bnez	s11,ffffffffc0203d34 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203d40:	00044783          	lbu	a5,0(s0)
ffffffffc0203d44:	00140a13          	addi	s4,s0,1
ffffffffc0203d48:	0007851b          	sext.w	a0,a5
ffffffffc0203d4c:	d3a5                	beqz	a5,ffffffffc0203cac <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203d4e:	05e00413          	li	s0,94
ffffffffc0203d52:	bf39                	j	ffffffffc0203c70 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0203d54:	000a2403          	lw	s0,0(s4)
ffffffffc0203d58:	b7ad                	j	ffffffffc0203cc2 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0203d5a:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d5e:	46a1                	li	a3,8
ffffffffc0203d60:	8a2e                	mv	s4,a1
ffffffffc0203d62:	bdb1                	j	ffffffffc0203bbe <vprintfmt+0x156>
ffffffffc0203d64:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d68:	46a9                	li	a3,10
ffffffffc0203d6a:	8a2e                	mv	s4,a1
ffffffffc0203d6c:	bd89                	j	ffffffffc0203bbe <vprintfmt+0x156>
ffffffffc0203d6e:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d72:	46c1                	li	a3,16
ffffffffc0203d74:	8a2e                	mv	s4,a1
ffffffffc0203d76:	b5a1                	j	ffffffffc0203bbe <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0203d78:	9902                	jalr	s2
ffffffffc0203d7a:	bf09                	j	ffffffffc0203c8c <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0203d7c:	85a6                	mv	a1,s1
ffffffffc0203d7e:	02d00513          	li	a0,45
ffffffffc0203d82:	e03e                	sd	a5,0(sp)
ffffffffc0203d84:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0203d86:	6782                	ld	a5,0(sp)
ffffffffc0203d88:	8a66                	mv	s4,s9
ffffffffc0203d8a:	40800633          	neg	a2,s0
ffffffffc0203d8e:	46a9                	li	a3,10
ffffffffc0203d90:	b53d                	j	ffffffffc0203bbe <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0203d92:	03b05163          	blez	s11,ffffffffc0203db4 <vprintfmt+0x34c>
ffffffffc0203d96:	02d00693          	li	a3,45
ffffffffc0203d9a:	f6d79de3          	bne	a5,a3,ffffffffc0203d14 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0203d9e:	00002417          	auipc	s0,0x2
ffffffffc0203da2:	a6240413          	addi	s0,s0,-1438 # ffffffffc0205800 <default_pmm_manager+0xaf0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203da6:	02800793          	li	a5,40
ffffffffc0203daa:	02800513          	li	a0,40
ffffffffc0203dae:	00140a13          	addi	s4,s0,1
ffffffffc0203db2:	bd6d                	j	ffffffffc0203c6c <vprintfmt+0x204>
ffffffffc0203db4:	00002a17          	auipc	s4,0x2
ffffffffc0203db8:	a4da0a13          	addi	s4,s4,-1459 # ffffffffc0205801 <default_pmm_manager+0xaf1>
ffffffffc0203dbc:	02800513          	li	a0,40
ffffffffc0203dc0:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203dc4:	05e00413          	li	s0,94
ffffffffc0203dc8:	b565                	j	ffffffffc0203c70 <vprintfmt+0x208>

ffffffffc0203dca <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203dca:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0203dcc:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203dd0:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0203dd2:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203dd4:	ec06                	sd	ra,24(sp)
ffffffffc0203dd6:	f83a                	sd	a4,48(sp)
ffffffffc0203dd8:	fc3e                	sd	a5,56(sp)
ffffffffc0203dda:	e0c2                	sd	a6,64(sp)
ffffffffc0203ddc:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0203dde:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0203de0:	c89ff0ef          	jal	ra,ffffffffc0203a68 <vprintfmt>
}
ffffffffc0203de4:	60e2                	ld	ra,24(sp)
ffffffffc0203de6:	6161                	addi	sp,sp,80
ffffffffc0203de8:	8082                	ret

ffffffffc0203dea <strlen>:
...
strlen(const char *s) {
ffffffffc0203dee:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0203df0:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0203df2:	cb81                	beqz	a5,ffffffffc0203e02 <strlen+0x18>
        cnt ++;
ffffffffc0203df4:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0203df6:	00a707b3          	add	a5,a4,a0
ffffffffc0203dfa:	0007c783          	lbu	a5,0(a5)
ffffffffc0203dfe:	fbfd                	bnez	a5,ffffffffc0203df4 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0203e04:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0203e06:	e589                	bnez	a1,ffffffffc0203e10 <strnlen+0xc>
ffffffffc0203e08:	a811                	j	ffffffffc0203e1c <strnlen+0x18>
        cnt ++;
ffffffffc0203e0a:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0203e0c:	00f58863          	beq	a1,a5,ffffffffc0203e1c <strnlen+0x18>
ffffffffc0203e10:	00f50733          	add	a4,a0,a5
ffffffffc0203e14:	00074703          	lbu	a4,0(a4)
ffffffffc0203e18:	fb6d                	bnez	a4,ffffffffc0203e0a <strnlen+0x6>
ffffffffc0203e1a:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0203e1c:	852e                	mv	a0,a1
ffffffffc0203e1e:	8082                	ret

ffffffffc0203e20 <strcpy>:
char *
...
ffffffffc0203e26:	0785                	addi	a5,a5,1
ffffffffc0203e28:	0585                	addi	a1,a1,1
ffffffffc0203e2a:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0203e2e:	fb75                	bnez	a4,ffffffffc0203e22 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0203e36:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203e3a:	cb89                	beqz	a5,ffffffffc0203e4c <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0203e3c:	0505                	addi	a0,a0,1
ffffffffc0203e3e:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203e40:	fee789e3          	beq	a5,a4,ffffffffc0203e32 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203e44:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0203e48:	9d19                	subw	a0,a0,a4
ffffffffc0203e4a:	8082                	ret
ffffffffc0203e4c:	4501                	li	a0,0
ffffffffc0203e4e:	bfed                	j	ffffffffc0203e48 <strcmp+0x16>

ffffffffc0203e50 <strncmp>:
...
ffffffffc0203e50:	c20d                	beqz	a2,ffffffffc0203e72 <strncmp+0x22>
ffffffffc0203e52:	962e                	add	a2,a2,a1
ffffffffc0203e54:	a031                	j	ffffffffc0203e60 <strncmp+0x10>
        n --, s1 ++, s2 ++;
ffffffffc0203e56:	0505                	addi	a0,a0,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0203e58:	00e79a63          	bne	a5,a4,ffffffffc0203e6c <strncmp+0x1c>
ffffffffc0203e5c:	00b60b63          	beq	a2,a1,ffffffffc0203e72 <strncmp+0x22>
ffffffffc0203e60:	00054783          	lbu	a5,0(a0)
        n --, s1 ++, s2 ++;
ffffffffc0203e64:	0585                	addi	a1,a1,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0203e66:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0203e6a:	f7f5                	bnez	a5,ffffffffc0203e56 <strncmp+0x6>
    }
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc0203e76:	00054783          	lbu	a5,0(a0)
ffffffffc0203e7a:	c799                	beqz	a5,ffffffffc0203e88 <strchr+0x12>
        if (*s == c) {
ffffffffc0203e7c:	00f58763          	beq	a1,a5,ffffffffc0203e8a <strchr+0x14>
    while (*s != '\0') {
ffffffffc0203e80:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0203e84:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0203e86:	fbfd                	bnez	a5,ffffffffc0203e7c <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0203e8c:	ca01                	beqz	a2,ffffffffc0203e9c <memset+0x10>
ffffffffc0203e8e:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0203e90:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0203e92:	0785                	addi	a5,a5,1
ffffffffc0203e94:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0203e98:	fec79de3          	bne	a5,a2,ffffffffc0203e92 <memset+0x6>
    }
    return s;
...
ffffffffc0203e9e <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0203e9e:	ca19                	beqz	a2,ffffffffc0203eb4 <memcpy+0x16>
ffffffffc0203ea0:	962e                	add	a2,a2,a1
    char *d = dst;
...
ffffffffc0203eac:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0203eb0:	fec59ae3          	bne	a1,a2,ffffffffc0203ea4 <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0203eb6:	c205                	beqz	a2,ffffffffc0203ed6 <memcmp+0x20>
ffffffffc0203eb8:	962e                	add	a2,a2,a1
ffffffffc0203eba:	a019                	j	ffffffffc0203ec0 <memcmp+0xa>
ffffffffc0203ebc:	00c58d63          	beq	a1,a2,ffffffffc0203ed6 <memcmp+0x20>
        if (*s1 != *s2) {
...
ffffffffc0203eca:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0203ecc:	fee788e3          	beq	a5,a4,ffffffffc0203ebc <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203ed0:	40e7853b          	subw	a0,a5,a4
ffffffffc0203ed4:	8082                	ret
    }
    return 0;
ffffffffc0203ed6:	4501                	li	a0,0
}
